...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/Hex/hexmerge.py ${TARGET_BASEPATH}.hex ${TARGET_BASEPATH}_before_hexmerge.hex_ "${SCRIPT_DIR}"/../../../Work/FactoryBlock_qpg6200_DoorWindow/FactoryBlock_qpg6200_DoorWindow.hex "${SCRIPT_DIR}"/../../../Work/PersistentStorageBlock_qpg6200_Sec_DoorWindow/PersistentStorageBlock_qpg6200_Sec_DoorWindow.hex --ignore_start_execution_addr --overlap keep_last
