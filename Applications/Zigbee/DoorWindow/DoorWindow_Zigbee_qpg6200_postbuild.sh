...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/Hex/hexmerge.py ${TARGET_BASEPATH}.hex ${TARGET_BASEPATH}_before_hexmerge.hex_ "${SCRIPT_DIR}"/../../../Work/Bootloader_qpg6200/Bootloader_qpg6200.hex "${SCRIPT_DIR}"/../../../Work/FactoryBlock_qpg6200_DoorWindow/FactoryBlock_qpg6200_DoorWindow.hex "${SCRIPT_DIR}"/../../../Work/PersistentStorageBlock_qpg6200_DoorWindow/PersistentStorageBlock_qpg6200_DoorWindow.hex --ignore_start_execution_addr --overlap keep_last

"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/MemoryOverview/memoryoverview.py --logfile "${SCRIPT_DIR}"/../../../Work/DoorWindow_Zigbee_qpg6200/DoorWindow_Zigbee_qpg6200.memoryoverview --only-this "${SCRIPT_DIR}"/../../../Work/DoorWindow_Zigbee_qpg6200/DoorWindow_Zigbee_qpg6200.map
