...
#define QPINCFG_UNUSED                                                                                                 \
    QPINCFG_GPIO_LIST(PB1_BUTTON_GPIO_PIN, PB2_BUTTON_GPIO_PIN, PB4_BUTTON_GPIO_PIN, WHITE_COOL_LED_GPIO_PIN,          \
                      WHITE_WARM_LED_GPIO_PIN, RED_LED_GPIO_PIN, BLUE_LED_GPIO_PIN, ANIO0_GPIO_PIN, EXT_32KXTAL_P,     \
                      EXT_32KXTAL_N, DEBUG_SWJDP_SWDIO_TMS_GPIO, DEBUG_SWJDP_SWCLK_TCK_GPIO, BOARD_UNUSED_GPIO_PINS)
