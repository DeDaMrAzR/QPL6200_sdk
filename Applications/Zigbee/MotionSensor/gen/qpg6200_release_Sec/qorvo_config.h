...
#define GP_VERSIONINFO_APP                                        MotionSensor_Sec_Zigbee_qpg6200_release
#define GP_VERSIONINFO_BASE_COMPS                                 0,0,0,0
#define GP_VERSIONINFO_BLE_COMPS                                  0,0,0,0
#define GP_VERSIONINFO_DATE                                       2026-03-11
#define GP_VERSIONINFO_GLOBAL_VERSION                             2,0,0,1
#define GP_VERSIONINFO_GLOBAL_VERSION_OVERWRITE                   2,0,0,1
...
/* Component ID that uses buffered logging. Logging will be printed on first newline */
#define GP_LOG_BUFFERED_COMPID                                    GP_COMPONENT_ID_UBIZPRO
...
/* Ubisys start point for NVM data */
#define __C7BFB_BASE                                              GP_MM_CMA_NVM_LINEAR_START+GP_KX_FLASH_SIZE*1024+GP_DATA_SECTION_START_FACTORY

/* Ubisys sizeof time_t */
#define __COMPACT_TIME_T                                          64

/* ubisys internal flag for XP4001 */
#define __COMPACT_XP4001

/* ubisys internal flag */
#define __CPACKET_SIZETYPE_8__
