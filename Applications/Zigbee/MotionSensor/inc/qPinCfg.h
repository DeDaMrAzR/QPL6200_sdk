...
#define APP_OCCUPANCY_BUTTON    PB3_BUTTON_GPIO_PIN
#define APP_ILLUMINANCE_BUTTON  PB1_BUTTON_GPIO_PIN
#define APP_CONTROL_MODE_BUTTON PB4_BUTTON_GPIO_PIN

// Mapping of LEDs
#define ZIGBEE_STATE_LED GREEN_LED_GPIO_PIN
...
#define QPINCFG_BUTTONS                                                                                                \
    QPINCFG_GPIO_LIST(APP_MULTI_FUNC_BUTTON, APP_OCCUPANCY_BUTTON, APP_ILLUMINANCE_BUTTON, APP_CONTROL_MODE_BUTTON)

// --- Mapping GPIOs to LEDs
#define QPINCFG_STATUS_LED QPINCFG_GPIO_LIST(ZIGBEE_STATE_LED)

// --- Unused pins
#define QPINCFG_UNUSED                                                                                                 \
    QPINCFG_GPIO_LIST(PB2_BUTTON_GPIO_PIN, SW_BUTTON_GPIO_PIN, WHITE_COOL_LED_GPIO_PIN, WHITE_WARM_LED_GPIO_PIN,       \
                      RED_LED_GPIO_PIN, BLUE_LED_GPIO_PIN, ANIO0_GPIO_PIN, EXT_32KXTAL_P, EXT_32KXTAL_N,               \
