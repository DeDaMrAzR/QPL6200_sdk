...
/** @file "OccupancySensorApplication.h"
 *
 * Class declaration of Occupancy Sensor endpoint.
 * All the members of the class are declared here
 * Provides a PIR sensor application using the Occupancy Sensing cluster.
 */

#ifndef _OCCUPANCYSENSORAPPLICATION_H_
#define _OCCUPANCYSENSORAPPLICATION_H_

/** @brief Class COccupancySensorApplication definition */
class COccupancySensorApplication : public CZigBeeFoundationApplication
{
    ...
    public:
        ...
        /** @brief Enums for Deivce ID - Occupancy Sensor */
        enum { deviceID = 0x0107};

        /** @brief define the default occupied to unoccupied delay */
        enum { defaultOccupiedToUnoccupiedDelay = 5};

    // Construction
    public:
        /** @brief COccupancySensorApplication constructor method */
        COccupancySensorApplication(CZigBeeApplicationSupport &aps,
    ...
    public:
        ...
        /** @brief Instance of Occupancy Sensing cluster */
        CQorvoClusterPIROccupancySensing m_occupancySensing;
    ...
    public:
        ...
        /** @brief Function to set occupancy attribute */
        void SetOccupancyStatus(bool occupied);
    ...
    public:
        ...
        /** @brief This function is called internally when the PIROccupiedToUnoccupiedDelay attribute has changed */
        void OnUpdatePIROccupiedToUnoccupiedDelay(const unsigned char nOptions);
};

#endif // _OCCUPANCYSENSORAPPLICATION_H_
