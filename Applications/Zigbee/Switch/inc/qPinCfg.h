...
#define QPINCFG_BUTTONS                                                                                                \
    QPINCFG_GPIO_LIST(APP_MULTI_FUNC_BUTTON, APP_LEVEL_BUTTON, APP_COLOR_BUTTON, APP_TOGGLE_BUTTON, APP_FUNCTION2_SWITCH)
...
#define QPINCFG_UNUSED                                                                                                 \
    QPINCFG_GPIO_LIST(WHITE_COOL_LED_GPIO_PIN, WHITE_WARM_LED_GPIO_PIN, RED_LED_GPIO_PIN, BLUE_LED_GPIO_PIN,           \
                      ANIO0_GPIO_PIN, SW_BUTTON_GPIO_PIN, EXT_32KXTAL_P, EXT_32KXTAL_N, DEBUG_SWJDP_SWDIO_TMS_GPIO,    \
                      DEBUG_SWJDP_SWCLK_TCK_GPIO, BOARD_UNUSED_GPIO_PINS)
