...
public:
    ...
    bool IsSyncClusterToButtonAction(void) { return mSyncClusterToButtonAction; }
    void SetSyncClusterToButtonAction(bool value) { mSyncClusterToButtonAction = value; }
...
private:
    ...
    static void UpdateDeviceLedState(void);
