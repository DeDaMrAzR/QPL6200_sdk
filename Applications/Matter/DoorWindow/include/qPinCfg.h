...
#define DOORWINDOW_SENSOR_BUTTON PB4_BUTTON_GPIO_PIN

// Mapping of LEDs
#define SYSTEM_STATE_LED WHITE_COOL_LED_GPIO_PIN
#define DOORWINDOW_SENSOR_LED WHITE_WARM_LED_GPIO_PIN
...
#define QPINCFG_BUTTONS QPINCFG_GPIO_LIST(APP_FUNCTION_BUTTON, DOORWINDOW_SENSOR_BUTTON)

// --- Mapping GPIOs to LEDs
#define QPINCFG_STATUS_LED QPINCFG_GPIO_LIST(SYSTEM_STATE_LED, DOORWINDOW_SENSOR_LED)

// --- Unused pins
#define QPINCFG_UNUSED                                                                                                             \
    QPINCFG_GPIO_LIST(PB1_BUTTON_GPIO_PIN, PB2_BUTTON_GPIO_PIN, PB3_BUTTON_GPIO_PIN, ANIO0_GPIO_PIN, ANIO1_GPIO_PIN,               \
