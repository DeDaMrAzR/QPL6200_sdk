...
#define LIGHT_SENSOR_BUTTON PB1_BUTTON_GPIO_PIN
#define PIR_SENSOR_BUTTON PB3_BUTTON_GPIO_PIN

// Mapping of LEDs
#define SYSTEM_STATE_LED WHITE_COOL_LED_GPIO_PIN
#define MOTION_SENSOR_LED WHITE_WARM_LED_GPIO_PIN
...
#define QPINCFG_BUTTONS QPINCFG_GPIO_LIST(APP_FUNCTION_BUTTON, LIGHT_SENSOR_BUTTON, PIR_SENSOR_BUTTON)

// --- Mapping GPIOs to LEDs
#define QPINCFG_STATUS_LED QPINCFG_GPIO_LIST(SYSTEM_STATE_LED, MOTION_SENSOR_LED)

// --- Unused pins
#define QPINCFG_UNUSED                                                                                                             \
    QPINCFG_GPIO_LIST(PB2_BUTTON_GPIO_PIN, PB4_BUTTON_GPIO_PIN, ANIO0_GPIO_PIN, ANIO1_GPIO_PIN, EXT_32KXTAL_P, EXT_32KXTAL_N,      \
