...
1. Remote lighting control (dimming, on/off) using a Matter&trade; or a Zigbee 3.0 controller.
2. Bluetooth LE for Matter&trade; commissioning procedure.
...
| GPIO0| Input (Pull-up)| SW9| Multiple functionalities:<br /> - Trigger OTA - (released in 0-3s)<br /> - Factory Reset (released in 6-8s)<br /> - Application Switch (release after >12s)|
| GPIO2| Output| LD7| Light status indicator:<br /> - **Short blink every 1s**: The device is in idle state (not commissioned yet and not Bluetooth LE advertising).<br /> - **Very fast blinks**: Bluetooth LE advertising.<br /> - **Fast blinks**: Bluetooth LE connected and subscribed but not yet commissioned.<br /> - **On**: Full service connectivity|
...
The Combo Switch application is composed of:

1. [Application Bootloader](../../Bootloader/README.md).
2. [Matter Switch application](../../Matter/Switch/README.md) (primary application).
3. [Zigbee Switch application](../../Zigbee/Switch/README.md) (secondary application).
...
how to build and program the Combo Switch example application.

## Testing the example

The Combo Switch application will not start any advertisement or commissioning at start-up if it is was not commissioned before.
