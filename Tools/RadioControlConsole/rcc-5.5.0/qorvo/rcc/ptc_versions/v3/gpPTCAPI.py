...
gpPTC_AttributeTXPower = 0x0A  # noqa E221
gpPTC_AttributePanID = 0x0B  # noqa E221
gpPTC_AttributeShortAddress = 0x0C  # noqa E221
gpPTC_AttributeCWMode = 0x0D  # noqa E221
gpPTC_AttributePowerControlLoop = 0x0E  # noqa E221
# @brief Value representing the address that will be used with the ReadRegister mode.
gpPTC_AttributeReadRegisterAddress = 0x0F  # noqa E221
# @brief Value representing the address that will be used with the WriteRegister mode.
gpPTC_AttributeWriteRegisterAddress = 0x10  # noqa E221
# @brief Value that will be written to selected register with the WrigeRegister mode.
gpPTC_AttributeWriteRegisterValue = 0x11  # noqa E221
# @brief Special case to set the byte array as the data payload for tx
gpPTC_AttributeSetTxData = 0x12  # noqa E221
# @brief Sets the interval between packets in a packet train when transmitting multiple packets.
gpPTC_AttributePacketIntervalInMS = 0x13  # noqa E221
# @brief Number of scans to be done by ED Scan
gpPTC_AttributeScanCount = 0x14  # noqa E221
# @brief Number of packets that will be transmitted in a packet train.
gpPTC_AttributePacketCount = 0x15  # noqa E221
gpPTC_AttributePacketInPacket = 0x16  # noqa E221
gpPTC_AttributePromiscuousMode = 0x17  # noqa E221
gpPTC_AttributePacketLength = 0x18  # noqa E221
# @brief Write register values only for the specified bitmask
gpPTC_AttributeWriteRegisterBitsMask = 0x19  # noqa E221
gpPTC_AttributeWriteRegisterBitsValue = 0x1A  # noqa E221
gpPTC_AttributePhyMode = 0x1B  # noqa E221
gpPTC_BLE_DTM_PacketType = 0x1C  # noqa E221
gpPTC_AttributeScanIntervalInMS = 0x1D  # noqa E221
gpPTC_BLE_DataRate = 0x1E  # noqa E221
gpPTC_AttributeMapClockType = 0x1F  # noqa E221
gpPTC_AttributeMapClockIOPin = 0x20  # noqa E221
gpPTC_AttributeRxLnaAttDuringTimeout = 0x21  # noqa E221
gpPTC_AttributeRxMultiStandard = 0x22  # noqa E221
gpPTC_AttributeRxHighSensitivity = 0x23  # noqa E221
gpPTC_AttributeRxMultiChannel = 0x24  # noqa E221
gpPTC_AttributePDMClkSrc = 0x25  # noqa E221
gpPTC_AttributePDMClkFreq = 0x26  # noqa E221
gpPTC_AttributePDMClkOutPin = 0x27  # noqa E221
# @brief Channel that the device will transmit or listen on (for all PHYs). Alias for deprecated "CH"
gpPTC_AttributeChannelSrcId0 = 0x28  # noqa E221
# @brief 802.15.4 rx channel of SrcId 1 that the device will listen on when ConcurrentConect multi-channel is enabled
gpPTC_AttributeChannelSrcId1 = 0x29  # noqa E221
# @brief 802.15.4 rx channel of SrcId 2 that the device will listen on when ConcurrentConect multi-channel is enabled
gpPTC_AttributeChannelSrcId2 = 0x2A  # noqa E221
# @brief Max temperature limits zone is split from next zone [-39-124°C]. The following values need to be incremented by 1 as the logic depends on it.
gpPTC_AttributeXtalTrimCapZone1MaxTemp = 0x2B  # noqa E221
gpPTC_AttributeXtalTrimCapZone2MaxTemp = 0x2C  # noqa E221
gpPTC_AttributeXtalTrimCapZone3MaxTemp = 0x2D  # noqa E221
gpPTC_AttributeXtalTrimCapZone4MaxTemp = 0x2E  # noqa E221
gpPTC_AttributeXtalTrimCapZone5MaxTemp = 0x2F  # noqa E221
gpPTC_AttributeXtalTrimCapZone6MaxTemp = 0x30  # noqa E221
# @brief Setting for trim capacitance register corresponding to temperature zone. The following values need to be incremented by 1 as the logic depends on it.
gpPTC_AttributeXtalTrimCapZone1Setting = 0x31  # noqa E221
gpPTC_AttributeXtalTrimCapZone2Setting = 0x32  # noqa E221
gpPTC_AttributeXtalTrimCapZone3Setting = 0x33  # noqa E221
gpPTC_AttributeXtalTrimCapZone4Setting = 0x34  # noqa E221
gpPTC_AttributeXtalTrimCapZone5Setting = 0x35  # noqa E221
gpPTC_AttributeXtalTrimCapZone6Setting = 0x36  # noqa E221
gpPTC_AttributeXtalTrimCapZone7Setting = 0x37  # noqa E221
gpPTC_AttributeWsetChannel = 0x38  # noqa E221
gpPTC_AttributeWgetChannel = 0x39  # noqa E221
gpPTC_AttributeWsetPower = 0x3A  # noqa E221
gpPTC_AttributeTxmcCurrentSrcId = 0x3B  # noqa E221
gpPTC_AttributeTxmcChannel = 0x3C  # noqa E221
gpPTC_AttributeTxmcPacketCount = 0x3D  # noqa E221
gpPTC_AttributeTxmcData = 0x3E  # noqa E221
gpPTC_AttributeTxmcDataLength = 0x3F  # noqa E221
gpPTC_AttributeTxmcPacketInterval = 0x40  # noqa E221
gpPTC_AttributePCHStatChannel = 0x41  # noqa E221
gpPTC_AttributeDumpRxp = 0x42  # noqa E221
gpPTC_AttributeDumpP = 0x43  # noqa E221
# @brief Flag controlling the DCDC mode.
gpPTC_AttributeDCDC = 0x44  # noqa E221
gpPTC_BLE_RxDataRate = 0x45  # noqa E221
gpPTC_BLE_TxDataRate = 0x46  # noqa E221
...
PTC_ATTRIBUTES_MAX_NUMBER = 0x47
gpPTC_AttributeId_t = {
    ...
    gpPTC_AttributeChannelSrcId0: "gpPTC_AttributeChannelSrcId0",  # noqa E221
    gpPTC_AttributeChannelSrcId1: "gpPTC_AttributeChannelSrcId1",  # noqa E221
    gpPTC_AttributeChannelSrcId2: "gpPTC_AttributeChannelSrcId2",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone1MaxTemp: "gpPTC_AttributeXtalTrimCapZone1MaxTemp",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone2MaxTemp: "gpPTC_AttributeXtalTrimCapZone2MaxTemp",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone3MaxTemp: "gpPTC_AttributeXtalTrimCapZone3MaxTemp",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone4MaxTemp: "gpPTC_AttributeXtalTrimCapZone4MaxTemp",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone5MaxTemp: "gpPTC_AttributeXtalTrimCapZone5MaxTemp",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone6MaxTemp: "gpPTC_AttributeXtalTrimCapZone6MaxTemp",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone1Setting: "gpPTC_AttributeXtalTrimCapZone1Setting",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone2Setting: "gpPTC_AttributeXtalTrimCapZone2Setting",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone3Setting: "gpPTC_AttributeXtalTrimCapZone3Setting",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone4Setting: "gpPTC_AttributeXtalTrimCapZone4Setting",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone5Setting: "gpPTC_AttributeXtalTrimCapZone5Setting",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone6Setting: "gpPTC_AttributeXtalTrimCapZone6Setting",  # noqa E221
    gpPTC_AttributeXtalTrimCapZone7Setting: "gpPTC_AttributeXtalTrimCapZone7Setting",  # noqa E221
    gpPTC_AttributeWsetChannel: "gpPTC_AttributeWsetChannel",  # noqa E221
    gpPTC_AttributeWgetChannel: "gpPTC_AttributeWgetChannel",  # noqa E221
    gpPTC_AttributeWsetPower: "gpPTC_AttributeWsetPower",  # noqa E221
    gpPTC_AttributeTxmcCurrentSrcId: "gpPTC_AttributeTxmcCurrentSrcId",  # noqa E221
    gpPTC_AttributeTxmcChannel: "gpPTC_AttributeTxmcChannel",  # noqa E221
    gpPTC_AttributeTxmcPacketCount: "gpPTC_AttributeTxmcPacketCount",  # noqa E221
    gpPTC_AttributeTxmcData: "gpPTC_AttributeTxmcData",  # noqa E221
    gpPTC_AttributeTxmcDataLength: "gpPTC_AttributeTxmcDataLength",  # noqa E221
    gpPTC_AttributeTxmcPacketInterval: "gpPTC_AttributeTxmcPacketInterval",  # noqa E221
    gpPTC_AttributePCHStatChannel: "gpPTC_AttributePCHStatChannel",  # noqa E221
    gpPTC_AttributeDumpRxp: "gpPTC_AttributeDumpRxp",  # noqa E221
    gpPTC_AttributeDumpP: "gpPTC_AttributeDumpP",  # noqa E221
    gpPTC_AttributeDCDC: "gpPTC_AttributeDCDC",  # noqa E221
    gpPTC_BLE_RxDataRate: "gpPTC_BLE_RxDataRate",  # noqa E221
    gpPTC_BLE_TxDataRate: "gpPTC_BLE_TxDataRate",  # noqa E221
...
gpPTC_ModePrintPacketCount = 0x0A  # noqa E221
gpPTC_ModeResetCounters = 0x0B  # noqa E221
gpPTC_ModePrintReceivedPackets = 0x0C  # noqa E221
gpPTC_ModeTransmitRandomPackets = 0x0D  # noqa E221
gpPTC_ModeWriteRegisterBits = 0x0E  # noqa E221
gpPTC_ModeSetClockToGPIO = 0x0F  # noqa E221
gpPTC_ModeXtalSelfTest = 0x10  # noqa E221
gpPTC_ModeSetPdmClock = 0x11  # noqa E221
gpPTC_ModeSetXtalTrim = 0x12  # noqa E221
gpPTC_SetTxPowerChannel = 0x13  # noqa E221
gpPTC_GetTxPowerChannel = 0x14  # noqa E221
gpPTC_ModeTransmitMultipleChannels = 0x15  # noqa E221
gpPTC_ModePrintTxmcConfiguraiton = 0x16  # noqa E221
gpPTC_ModePrintPacketCountForChannel = 0x17  # noqa E221
gpPTC_ModeResetCountersForChannel = 0x18  # noqa E221
gpPTC_ModePrintAntennaStatistics = 0x19  # noqa E221
gpPTC_ModeResetAntennaStatistics = 0x1A  # noqa E221
gpPTC_ModeGetChipTemp = 0x1B  # noqa E221
gpPTC_ModeGetCapacitorLoad = 0x1C  # noqa E221
gpPTC_ModeId_t = {
    ...
    gpPTC_ModeSetXtalTrim: "gpPTC_ModeSetXtalTrim",  # noqa E221
    gpPTC_SetTxPowerChannel: "gpPTC_SetTxPowerChannel",  # noqa E221
    gpPTC_GetTxPowerChannel: "gpPTC_GetTxPowerChannel",  # noqa E221
    gpPTC_ModeTransmitMultipleChannels: "gpPTC_ModeTransmitMultipleChannels",  # noqa E221
    gpPTC_ModePrintTxmcConfiguraiton: "gpPTC_ModePrintTxmcConfiguraiton",  # noqa E221
    gpPTC_ModePrintPacketCountForChannel: "gpPTC_ModePrintPacketCountForChannel",  # noqa E221
    gpPTC_ModeResetCountersForChannel: "gpPTC_ModeResetCountersForChannel",  # noqa E221
    gpPTC_ModePrintAntennaStatistics: "gpPTC_ModePrintAntennaStatistics",  # noqa E221
    gpPTC_ModeResetAntennaStatistics: "gpPTC_ModeResetAntennaStatistics",  # noqa E221
    gpPTC_ModeGetChipTemp: 'gpPTC_ModeGetChipTemp',  # noqa E221
    gpPTC_ModeGetCapacitorLoad:  'gpPTC_ModeGetCapacitorLoad',  # noqa E221
}
# @}
...
# @brief The Tx data for rf4ce transmit packet is not set
gpPTC_ResultTXDataNotSet = 0x0a  # noqa E221
# @brief Invalid Tx data length for rf4ce transmit packet
gpPTC_ResultInvalidTXDataLength = 0x0b  # noqa E221
gpPTC_Result_t = {
    ...
    gpPTC_ResultTXDataNotSet : 'gpPTC_ResultTXDataNotSet',   # noqa E221
    gpPTC_ResultInvalidTXDataLength : 'gpPTC_ResultInvalidTXDataLength',  # noqa E221
}
# @}
...
# *                    Macro Definitions
# *****************************************************************************/
GP_PTC_API_VERSION = 3  # noqa E221
...
gpPTC_Commands = {
    ...
    # Requests
    gpPTC_SetClientIDRequest_CmdId: ["gpPTC_SetClientIDRequest", 0, [["clientID", 1]], [], True],
    ...
    gpPTC_GetDUTApiVersion_CmdId: ["gpPTC_GetDUTApiVersion", 0, [], [["version", 4]], True],
    ...
    gpPTC_GetModeRequest_CmdId: ["gpPTC_GetModeRequest", 0, [["clientID", 1], ["modeID", 1]], [["OnOff", 1]], True],
    ...
    gpPTC_EDConfirm_CmdId: ["gpPTC_EDConfirm", 0, [["result", 1], ["finished", 1], ["EDValue", 2]], [], False],
}
