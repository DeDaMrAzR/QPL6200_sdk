...
#define AUTHENTICATION_HEADER_OFFSET                   (308)
#define APPUC_FW_HEADER_RESERVED                       (388)
#endif
...
/* BootAddr mask out three MSB of the address. */
#define USER_LICENSE_BOOT_ADDRESS_BITMASK (0x1FFFFFFF)
...
#if defined(GP_DIVERSITY_APPUC_FW_HEADER)
#define USER_LICENSE_VPP_OFFSET                        (AUTHENTICATION_HEADER_OFFSET+12)
#else
#define USER_LICENSE_VPP_OFFSET                        (0x1C)
#endif
#if defined(GP_DIVERSITY_APPUC_FW_HEADER)
#define USER_LICENSE_PROGRAM_LOADED_MAGIC_WORD_OFFSET (APPUC_FW_HEADER_RESERVED)
#else
...
#if defined(GP_DIVERSITY_APPUC_FW_HEADER)
#define USER_LICENSE_LOAD_COMPLETED_MAGIC_WORD_OFFSET  (AUTHENTICATION_HEADER_OFFSET+20)
#else
#define USER_LICENSE_LOAD_COMPLETED_MAGIC_WORD_OFFSET  (0x78)
#endif
#if defined(GP_DIVERSITY_APPUC_FW_HEADER)
#define USER_LICENSE_FRESHNESS_COUNTER_OFFSET (APPUC_FW_HEADER_RESERVED + 4)
#else
