...
#ifdef HAL_DIVERSITY_GPIO_ISR_OVERRIDE
// Set an additional callback for given gpio interrupt (enables additional gpio interrupt when HAL_DIVERSITY_GPIO_ISR_OVERRIDE is set):
void halSpiSlave_AdditionalIntConfig(UInt8 gpio, UInt8 expVal, void (*pCb)(Bool));
#endif // HAL_DIVERSITY_GPIO_ISR_OVERRIDE
