...
#elif \
      defined(GP_DIVERSITY_GPHAL_XP4002) && defined(GP_DIVERSITY_CORTEXM4)
#  include "hal_MM.h"
#else
...
#define GP_HAL_BASE_READ_PROPFROM(Byte, Property) (UInt8) GP_HAL_PLACEDVAL2VAL(Byte, Property)
 ...
 * @param Property Property name (only use with regprop definition).
*/
#define GP_HAL_READ_PROPFROM(Byte, Reg, Property) GP_HAL_BASE_READ_PROPFROM(Byte, Property)
