...
/**
 * @brief Gets the availability of the 32kHz crystal.
 *
 * This function returns the current availability status of the 32kHz crystal.
 * It should be invoked after the initial benchmarking to verify if the 32kHz crystal is available and functional.
 *
 * @return Boolean value indicating the availability of the 32kHz crystal.
 *         - true: 32kHz crystal is available.
 *         - false: 32kHz crystal is not available.
 */
GP_API Bool gpHal_32kHzCrystalAvailable(void);
