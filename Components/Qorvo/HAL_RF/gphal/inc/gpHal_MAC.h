...
#ifndef GP_DIVERSITY_GPHAL_XP4002
 ...
 *
 * @param frameCounter        Initial value of the Frame counter. It will be autoincremented in consecutive
 * transmissions.
 ...
 */
GP_API Int8 gpHal_GetRadioSensitivity(void);

/** @brief This function returns the Rx Uncertainty.
 *
 * This designates the worst case constant positive or negative deviation of the actual arrival time
 * of a transmission from the transmission time calculated relative to the local radio clock
 * independent of elapsed time.
 *
 * @return The Uncertainty in units of 10 us.
 */
GP_API UInt8 gpHal_GetRxUncertainty(void);
