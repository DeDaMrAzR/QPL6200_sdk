...
#define GPHAL_BLE_VALIDATION_THRESHOLD_LOW          81
...
#define GPHAL_BLE_NR_OF_ADDR_SIGN_COMBINATIONS      7

// Advertising access code (0x8E89BED6) specific settings
#define GPHAL_BLE_ADV_ACCESS_ADDRESS                0x8E89BED6
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_0        (2)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_0        (0)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_1        (5)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_1        (0)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_2        (3)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_2        (0)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_3        (6)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_3        (0)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_4        (1)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_4        (1)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_5        (7)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_5        (0)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_ADDR_6        (3)
#define GPHAL_BLE_ADV_ACCESS_CODE_VAL_SIGN_6        (1)

// Direct test mode access code (0x71764129) specific settings
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_0        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_0        (1)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_1        (5)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_1        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_2        (2)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_2        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_3        (4)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_3        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_4        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_4        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_5        (4)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_5        (1)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_ADDR_6        (0)
#define GPHAL_BLE_DTM_ACCESS_CODE_VAL_SIGN_6        (1)
...
typedef struct {
    ...
    UInt8 validationAddr[GPHAL_BLE_NR_OF_ADDR_SIGN_COMBINATIONS];
    UInt8 validationSign[GPHAL_BLE_NR_OF_ADDR_SIGN_COMBINATIONS];
...
typedef struct gp_validation_rx_regmap gpHal_BleValidationRx_t;
...
Bool gpHal_BleValidationPopulateParameters(gpHal_BleValidationRx_t* pValidationRx, UInt8 rxPhy);
