...
typedef struct {
    gpTest_AntennaStatistics_t data[1];
} gpTest_AntennaStatistics_t_l1_pointer_marshall_t;
...
typedef struct {
    gpTest_Result_t result;
} gpTest_SetNumberOfRetries_Output_struct_t;

typedef struct {
    gpTest_SetNumberOfRetries_Output_struct_t data;
} gpTest_SetNumberOfRetries_Output_marshall_struct_t;
...
typedef struct {
    gpTest_AntennaSelection_t antenna;
} gpTest_BleGetNumberOfRxPackets_v2_Input_struct_t;

typedef struct {
    gpTest_BleGetNumberOfRxPackets_v2_Input_struct_t data;
} gpTest_BleGetNumberOfRxPackets_v2_Input_marshall_struct_t;

typedef struct {
    UInt16 gpTest_NumberOfRxPackets;
} gpTest_BleGetNumberOfRxPackets_v2_Output_struct_t;

typedef struct {
    gpTest_BleGetNumberOfRxPackets_v2_Output_struct_t data;
} gpTest_BleGetNumberOfRxPackets_v2_Output_marshall_struct_t;

#endif /* defined(GP_COMP_GPTEST_BLE) && !(defined(GP_DIVERSITY_GPHAL_K8A) || defined(GP_DIVERSITY_GPHAL_K8C) || defined(GP_DIVERSITY_GPHAL_K8D) || defined(GP_DIVERSITY_GPHAL_K8E)) */
...
typedef struct {
    ...
    Bool* enableMultiChannel;
    Bool* enableHighSensitivity;
} gpTest_GetRxModeOptions_Output_struct_t;

typedef struct {
    gpTest_GetRxModeOptions_Output_struct_t data;
    Bool enableMultiStandard[1];
    Bool enableMultiChannel[1];
    Bool enableHighSensitivity[1];
} gpTest_GetRxModeOptions_Output_marshall_struct_t;
...
typedef struct {
    Bool lowTemp;
} gpTest_IsLowTemp_Output_struct_t;

typedef struct {
    gpTest_IsLowTemp_Output_struct_t data;
} gpTest_IsLowTemp_Output_marshall_struct_t;


typedef struct {
    UInt8 zoneId;
} gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_struct_t;

typedef struct {
    gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_struct_t data;
} gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_marshall_struct_t;

typedef struct {
    UInt8 gpTest_Result_t;
    Int8* pOutMaxTemp;
} gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_struct_t;

typedef struct {
    gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_struct_t data;
    Int8 pOutMaxTemp[1];
} gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_marshall_struct_t;


typedef struct {
    UInt8 zoneId;
} gpTest_Xtal32MHzTrimGetZoneSetting_Input_struct_t;

typedef struct {
    gpTest_Xtal32MHzTrimGetZoneSetting_Input_struct_t data;
} gpTest_Xtal32MHzTrimGetZoneSetting_Input_marshall_struct_t;

typedef struct {
    UInt8 gpTest_Result_t;
    UInt8* pOutSetting;
} gpTest_Xtal32MHzTrimGetZoneSetting_Output_struct_t;

typedef struct {
    gpTest_Xtal32MHzTrimGetZoneSetting_Output_struct_t data;
    UInt8 pOutSetting[1];
} gpTest_Xtal32MHzTrimGetZoneSetting_Output_marshall_struct_t;
...
typedef struct {
    ...
    UInt8* pInSettigTab;
    UInt8 zoneCnt;
} gpTest_Xtal32MHzTrimConfigOverwrite_Input_struct_t;

typedef struct {
    gpTest_Xtal32MHzTrimConfigOverwrite_Input_struct_t data;
    Int8 pInMaxTempTab[6];
    UInt8 pInSettigTab[7];
} gpTest_Xtal32MHzTrimConfigOverwrite_Input_marshall_struct_t;

typedef struct {
    UInt8 gpTest_Result_t;
} gpTest_Xtal32MHzTrimConfigOverwrite_Output_struct_t;

typedef struct {
    gpTest_Xtal32MHzTrimConfigOverwrite_Output_struct_t data;
} gpTest_Xtal32MHzTrimConfigOverwrite_Output_marshall_struct_t;


typedef struct {
    UInt8 channel;
    Int8 transmitPower;
} gpTest_SetTxPowerChannel_Input_struct_t;

typedef struct {
    gpTest_SetTxPowerChannel_Input_struct_t data;
} gpTest_SetTxPowerChannel_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
} gpTest_SetTxPowerChannel_Output_struct_t;

typedef struct {
    gpTest_SetTxPowerChannel_Output_struct_t data;
} gpTest_SetTxPowerChannel_Output_marshall_struct_t;


typedef struct {
    UInt8 channel;
} gpTest_GetTxPowerChannel_Input_struct_t;

typedef struct {
    gpTest_GetTxPowerChannel_Input_struct_t data;
} gpTest_GetTxPowerChannel_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
    Int8* pTransmitPower;
} gpTest_GetTxPowerChannel_Output_struct_t;

typedef struct {
    gpTest_GetTxPowerChannel_Output_struct_t data;
    Int8 pTransmitPower[1];
} gpTest_GetTxPowerChannel_Output_marshall_struct_t;


typedef struct {
    UInt8 channel;
} gpTest_GetStatisticsForChannel_Input_struct_t;

typedef struct {
    gpTest_GetStatisticsForChannel_Input_struct_t data;
} gpTest_GetStatisticsForChannel_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
    gpTest_Statistics_t* pStatistics;
} gpTest_GetStatisticsForChannel_Output_struct_t;

typedef struct {
    gpTest_GetStatisticsForChannel_Output_struct_t data;
    gpTest_Statistics_t_l1_pointer_marshall_t pStatistics;
} gpTest_GetStatisticsForChannel_Output_marshall_struct_t;


typedef struct {
    UInt8 channel;
} gpTest_ResetStatisticsForChannel_Input_struct_t;

typedef struct {
    gpTest_ResetStatisticsForChannel_Input_struct_t data;
} gpTest_ResetStatisticsForChannel_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
} gpTest_ResetStatisticsForChannel_Output_struct_t;

typedef struct {
    gpTest_ResetStatisticsForChannel_Output_struct_t data;
} gpTest_ResetStatisticsForChannel_Output_marshall_struct_t;


typedef struct {
    UInt8 channel;
} gpTest_GetLQIForChannel_Input_struct_t;

typedef struct {
    gpTest_GetLQIForChannel_Input_struct_t data;
} gpTest_GetLQIForChannel_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
    UInt8* pLqi;
} gpTest_GetLQIForChannel_Output_struct_t;

typedef struct {
    gpTest_GetLQIForChannel_Output_struct_t data;
    UInt8 pLqi[1];
} gpTest_GetLQIForChannel_Output_marshall_struct_t;


typedef struct {
    UInt8 channel;
} gpTest_GetRSSIForChannel_Input_struct_t;

typedef struct {
    gpTest_GetRSSIForChannel_Input_struct_t data;
} gpTest_GetRSSIForChannel_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
    Int8* pRssi;
} gpTest_GetRSSIForChannel_Output_struct_t;

typedef struct {
    gpTest_GetRSSIForChannel_Output_struct_t data;
    Int8 pRssi[1];
} gpTest_GetRSSIForChannel_Output_marshall_struct_t;


typedef struct {
    gpTest_AntennaStatistics_t* pAnt0Statistics;
    gpTest_AntennaStatistics_t* pAnt1Statistics;
} gpTest_GetAntennaStatistics_Output_struct_t;

typedef struct {
    gpTest_GetAntennaStatistics_Output_struct_t data;
    gpTest_AntennaStatistics_t_l1_pointer_marshall_t pAnt0Statistics;
    gpTest_AntennaStatistics_t_l1_pointer_marshall_t pAnt1Statistics;
} gpTest_GetAntennaStatistics_Output_marshall_struct_t;



typedef struct {
    Int16 temp;
} gpTest_GetChipTemperature_Output_struct_t;

typedef struct {
    gpTest_GetChipTemperature_Output_struct_t data;
} gpTest_GetChipTemperature_Output_marshall_struct_t;


#if defined(GP_DIVERSITY_GPHAL_XP4002)
typedef struct {
    Bool dcdcOn;
} gpTest_SetDcdcMode_Input_struct_t;

typedef struct {
    gpTest_SetDcdcMode_Input_struct_t data;
} gpTest_SetDcdcMode_Input_marshall_struct_t;
...
typedef struct {
    gpTest_Result_t result;
    hal_StandbyPowerMode_t* pStandbyPowerMode;
    hal_ActivePowerMode_t* pActivePowerMode;
    hal_SleepMode_t* pSleepMode;
} gpTest_GetDcdcMode_Output_struct_t;

typedef struct {
    gpTest_GetDcdcMode_Output_struct_t data;
    hal_StandbyPowerMode_t pStandbyPowerMode[1];
    hal_ActivePowerMode_t pActivePowerMode[1];
    hal_SleepMode_t pSleepMode[1];
} gpTest_GetDcdcMode_Output_marshall_struct_t;
...
typedef struct {
    gpTest_BleTxPhy_t modulation;
} gpTest_SetTxModulation_Input_struct_t;

typedef struct {
    gpTest_SetTxModulation_Input_struct_t data;
} gpTest_SetTxModulation_Input_marshall_struct_t;
...
typedef struct {
    UInt8 rxPhyMask;
} gpTest_SetRxPhyMask_Input_struct_t;

typedef struct {
    gpTest_SetRxPhyMask_Input_struct_t data;
} gpTest_SetRxPhyMask_Input_marshall_struct_t;

typedef struct {
    gpTest_Result_t result;
} gpTest_SetRxPhyMask_Output_struct_t;

typedef struct {
    gpTest_SetRxPhyMask_Output_struct_t data;
} gpTest_SetRxPhyMask_Output_marshall_struct_t;

#endif /* defined(GP_COMP_GPTEST_BLE) */

typedef struct {
    UInt8 tempIndex;
} gpTest_GetCapacitorLoad_Input_struct_t;

typedef struct {
    gpTest_GetCapacitorLoad_Input_struct_t data;
} gpTest_GetCapacitorLoad_Input_marshall_struct_t;

typedef struct {
    Int16 temp;
} gpTest_GetCapacitorLoad_Output_struct_t;

typedef struct {
    gpTest_GetCapacitorLoad_Output_struct_t data;
} gpTest_GetCapacitorLoad_Output_marshall_struct_t;


typedef struct {
    UInt8 size;
} gpTest_GetSizeOfCapacitorLoad_Output_struct_t;

typedef struct {
    gpTest_GetSizeOfCapacitorLoad_Output_struct_t data;
} gpTest_GetSizeOfCapacitorLoad_Output_marshall_struct_t;
...
typedef union {
...
#if defined(GP_COMP_GPTEST_BLE) 
    gpTest_BleGetNumberOfRxPackets_v2_Input_marshall_struct_t gpTest_BleGetNumberOfRxPackets_v2;
#endif /* defined(GP_COMP_GPTEST_BLE) && !(defined(GP_DIVERSITY_GPHAL_K8A) || defined(GP_DIVERSITY_GPHAL_K8C) || defined(GP_DIVERSITY_GPHAL_K8D) || defined(GP_DIVERSITY_GPHAL_K8E)) */
#if defined(GP_COMP_GPTEST_BLE)
    ...
    gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_marshall_struct_t gpTest_Xtal32MHzTrimGetZoneMaxTemp;
    gpTest_Xtal32MHzTrimGetZoneSetting_Input_marshall_struct_t gpTest_Xtal32MHzTrimGetZoneSetting;
    gpTest_Xtal32MHzTrimConfigOverwrite_Input_marshall_struct_t gpTest_Xtal32MHzTrimConfigOverwrite;
    gpTest_SetTxPowerChannel_Input_marshall_struct_t gpTest_SetTxPowerChannel;
    gpTest_GetTxPowerChannel_Input_marshall_struct_t gpTest_GetTxPowerChannel;
    gpTest_GetStatisticsForChannel_Input_marshall_struct_t gpTest_GetStatisticsForChannel;
    gpTest_ResetStatisticsForChannel_Input_marshall_struct_t gpTest_ResetStatisticsForChannel;
    gpTest_GetLQIForChannel_Input_marshall_struct_t gpTest_GetLQIForChannel;
    gpTest_GetRSSIForChannel_Input_marshall_struct_t gpTest_GetRSSIForChannel;
#if defined(GP_DIVERSITY_GPHAL_XP4002)
    gpTest_SetDcdcMode_Input_marshall_struct_t gpTest_SetDcdcMode;
#endif /* defined(GP_DIVERSITY_GPHAL_XP4002) */
#if defined(GP_COMP_GPTEST_BLE)
    gpTest_SetTxModulation_Input_marshall_struct_t gpTest_SetTxModulation;
#endif /* defined(GP_COMP_GPTEST_BLE) */
#if defined(GP_COMP_GPTEST_BLE)
    gpTest_SetRxPhyMask_Input_marshall_struct_t gpTest_SetRxPhyMask;
#endif /* defined(GP_COMP_GPTEST_BLE) */
    gpTest_GetCapacitorLoad_Input_marshall_struct_t gpTest_GetCapacitorLoad;
...
typedef union {
    ...
    gpTest_SetNumberOfRetries_Output_marshall_struct_t gpTest_SetNumberOfRetries;
...
#endif /* defined(GP_COMP_GPTEST_BLE) */
#if defined(GP_COMP_GPTEST_BLE) 
    gpTest_BleGetNumberOfRxPackets_v2_Output_marshall_struct_t gpTest_BleGetNumberOfRxPackets_v2;
#endif /* defined(GP_COMP_GPTEST_BLE) && !(defined(GP_DIVERSITY_GPHAL_K8A) || defined(GP_DIVERSITY_GPHAL_K8C) || defined(GP_DIVERSITY_GPHAL_K8D) || defined(GP_DIVERSITY_GPHAL_K8E)) */
    ...
    gpTest_GetRxModeOptions_Output_marshall_struct_t gpTest_GetRxModeOptions;
    ...
    gpTest_IsLowTemp_Output_marshall_struct_t gpTest_IsLowTemp;
    gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_marshall_struct_t gpTest_Xtal32MHzTrimGetZoneMaxTemp;
    gpTest_Xtal32MHzTrimGetZoneSetting_Output_marshall_struct_t gpTest_Xtal32MHzTrimGetZoneSetting;
    gpTest_Xtal32MHzTrimConfigOverwrite_Output_marshall_struct_t gpTest_Xtal32MHzTrimConfigOverwrite;
    gpTest_SetTxPowerChannel_Output_marshall_struct_t gpTest_SetTxPowerChannel;
    gpTest_GetTxPowerChannel_Output_marshall_struct_t gpTest_GetTxPowerChannel;
    gpTest_GetStatisticsForChannel_Output_marshall_struct_t gpTest_GetStatisticsForChannel;
    gpTest_ResetStatisticsForChannel_Output_marshall_struct_t gpTest_ResetStatisticsForChannel;
    gpTest_GetLQIForChannel_Output_marshall_struct_t gpTest_GetLQIForChannel;
    gpTest_GetRSSIForChannel_Output_marshall_struct_t gpTest_GetRSSIForChannel;
    gpTest_GetAntennaStatistics_Output_marshall_struct_t gpTest_GetAntennaStatistics;
    gpTest_GetChipTemperature_Output_marshall_struct_t gpTest_GetChipTemperature;
#if defined(GP_DIVERSITY_GPHAL_XP4002)
    gpTest_GetDcdcMode_Output_marshall_struct_t gpTest_GetDcdcMode;
#endif /* defined(GP_DIVERSITY_GPHAL_XP4002) */
#if defined(GP_COMP_GPTEST_BLE)
    gpTest_SetRxPhyMask_Output_marshall_struct_t gpTest_SetRxPhyMask;
#endif /* defined(GP_COMP_GPTEST_BLE) */
    gpTest_GetCapacitorLoad_Output_marshall_struct_t gpTest_GetCapacitorLoad;
    gpTest_GetSizeOfCapacitorLoad_Output_marshall_struct_t gpTest_GetSizeOfCapacitorLoad;
    UInt8 dummy; //ensure none empty union definition
...
#define hal_StandbyPowerMode_t_buf2api(pDest, pSource, length, pIndex) UInt16_buf2api(pDest, pSource, length, pIndex)
#define hal_StandbyPowerMode_t_api2buf(pDest, pSource, length, pIndex) UInt16_api2buf(pDest, pSource, length, pIndex)
#define hal_StandbyPowerMode_t_buf2api_1(pDest, pSource, pIndex)       UInt16_buf2api_1(pDest, pSource, pIndex)
#define hal_StandbyPowerMode_t_api2buf_1(pDest, pSource, pIndex)       UInt16_api2buf_1(pDest, pSource, pIndex)
#define hal_ActivePowerMode_t_buf2api(pDest, pSource, length, pIndex) UInt16_buf2api(pDest, pSource, length, pIndex)
#define hal_ActivePowerMode_t_api2buf(pDest, pSource, length, pIndex) UInt16_api2buf(pDest, pSource, length, pIndex)
#define hal_ActivePowerMode_t_buf2api_1(pDest, pSource, pIndex)       UInt16_buf2api_1(pDest, pSource, pIndex)
#define hal_ActivePowerMode_t_api2buf_1(pDest, pSource, pIndex)       UInt16_api2buf_1(pDest, pSource, pIndex)
#define hal_SleepMode_t_buf2api(pDest, pSource, length, pIndex) UInt16_buf2api(pDest, pSource, length, pIndex)
#define hal_SleepMode_t_api2buf(pDest, pSource, length, pIndex) UInt16_api2buf(pDest, pSource, length, pIndex)
#define hal_SleepMode_t_buf2api_1(pDest, pSource, pIndex)       UInt16_buf2api_1(pDest, pSource, pIndex)
#define hal_SleepMode_t_api2buf_1(pDest, pSource, pIndex)       UInt16_api2buf_1(pDest, pSource, pIndex)
...
gpMarshall_AckStatus_t gpTest_AntennaStatistics_t_buf2api(gpTest_AntennaStatistics_t* pDest , UInt8Buffer* pSource , UInt16 length , UInt16* pIndex );
void gpTest_AntennaStatistics_t_api2buf(UInt8Buffer* pDest , const gpTest_AntennaStatistics_t* pSource , UInt16 length , UInt16* pIndex);
...
void gpTest_SetNumberOfRetries_Output_api2buf(UInt8Buffer* pDest , gpTest_SetNumberOfRetries_Output_marshall_struct_t* pSourceoutput , gpTest_SetNumberOfRetries_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
...
#endif /* defined(GP_COMP_GPTEST_BLE) */
#if defined(GP_COMP_GPTEST_BLE) 
gpMarshall_AckStatus_t gpTest_BleGetNumberOfRxPackets_v2_Input_buf2api(gpTest_BleGetNumberOfRxPackets_v2_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_BleGetNumberOfRxPackets_v2_Output_api2buf(UInt8Buffer* pDest , gpTest_BleGetNumberOfRxPackets_v2_Output_marshall_struct_t* pSourceoutput , gpTest_BleGetNumberOfRxPackets_v2_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
#endif /* defined(GP_COMP_GPTEST_BLE) && !(defined(GP_DIVERSITY_GPHAL_K8A) || defined(GP_DIVERSITY_GPHAL_K8C) || defined(GP_DIVERSITY_GPHAL_K8D) || defined(GP_DIVERSITY_GPHAL_K8E)) */
#if defined(GP_COMP_GPTEST_BLE)
...
void gpTest_GetRxModeOptions_Output_api2buf(UInt8Buffer* pDest , gpTest_GetRxModeOptions_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
...
void gpTest_IsLowTemp_Output_api2buf(UInt8Buffer* pDest , gpTest_IsLowTemp_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_buf2api(gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_api2buf(UInt8Buffer* pDest , gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_marshall_struct_t* pSourceoutput , gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_Xtal32MHzTrimGetZoneSetting_Input_buf2api(gpTest_Xtal32MHzTrimGetZoneSetting_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_Xtal32MHzTrimGetZoneSetting_Output_api2buf(UInt8Buffer* pDest , gpTest_Xtal32MHzTrimGetZoneSetting_Output_marshall_struct_t* pSourceoutput , gpTest_Xtal32MHzTrimGetZoneSetting_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_Xtal32MHzTrimConfigOverwrite_Input_buf2api(gpTest_Xtal32MHzTrimConfigOverwrite_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_Xtal32MHzTrimConfigOverwrite_Output_api2buf(UInt8Buffer* pDest , gpTest_Xtal32MHzTrimConfigOverwrite_Output_marshall_struct_t* pSourceoutput , gpTest_Xtal32MHzTrimConfigOverwrite_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_SetTxPowerChannel_Input_buf2api(gpTest_SetTxPowerChannel_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_SetTxPowerChannel_Output_api2buf(UInt8Buffer* pDest , gpTest_SetTxPowerChannel_Output_marshall_struct_t* pSourceoutput , gpTest_SetTxPowerChannel_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_GetTxPowerChannel_Input_buf2api(gpTest_GetTxPowerChannel_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetTxPowerChannel_Output_api2buf(UInt8Buffer* pDest , gpTest_GetTxPowerChannel_Output_marshall_struct_t* pSourceoutput , gpTest_GetTxPowerChannel_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_GetStatisticsForChannel_Input_buf2api(gpTest_GetStatisticsForChannel_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetStatisticsForChannel_Output_api2buf(UInt8Buffer* pDest , gpTest_GetStatisticsForChannel_Output_marshall_struct_t* pSourceoutput , gpTest_GetStatisticsForChannel_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_ResetStatisticsForChannel_Input_buf2api(gpTest_ResetStatisticsForChannel_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_ResetStatisticsForChannel_Output_api2buf(UInt8Buffer* pDest , gpTest_ResetStatisticsForChannel_Output_marshall_struct_t* pSourceoutput , gpTest_ResetStatisticsForChannel_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_GetLQIForChannel_Input_buf2api(gpTest_GetLQIForChannel_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetLQIForChannel_Output_api2buf(UInt8Buffer* pDest , gpTest_GetLQIForChannel_Output_marshall_struct_t* pSourceoutput , gpTest_GetLQIForChannel_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpTest_GetRSSIForChannel_Input_buf2api(gpTest_GetRSSIForChannel_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetRSSIForChannel_Output_api2buf(UInt8Buffer* pDest , gpTest_GetRSSIForChannel_Output_marshall_struct_t* pSourceoutput , gpTest_GetRSSIForChannel_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
void gpTest_GetAntennaStatistics_Output_api2buf(UInt8Buffer* pDest , gpTest_GetAntennaStatistics_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
void gpTest_GetChipTemperature_Output_api2buf(UInt8Buffer* pDest , gpTest_GetChipTemperature_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
#if defined(GP_DIVERSITY_GPHAL_XP4002)
gpMarshall_AckStatus_t gpTest_SetDcdcMode_Input_buf2api(gpTest_SetDcdcMode_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_DIVERSITY_GPHAL_XP4002) */
#if defined(GP_DIVERSITY_GPHAL_XP4002)
void gpTest_GetDcdcMode_Output_api2buf(UInt8Buffer* pDest , gpTest_GetDcdcMode_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
#endif /* defined(GP_DIVERSITY_GPHAL_XP4002) */
#if defined(GP_COMP_GPTEST_BLE)
gpMarshall_AckStatus_t gpTest_SetTxModulation_Input_buf2api(gpTest_SetTxModulation_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_COMP_GPTEST_BLE) */
#if defined(GP_COMP_GPTEST_BLE)
gpMarshall_AckStatus_t gpTest_SetRxPhyMask_Input_buf2api(gpTest_SetRxPhyMask_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_SetRxPhyMask_Output_api2buf(UInt8Buffer* pDest , gpTest_SetRxPhyMask_Output_marshall_struct_t* pSourceoutput , gpTest_SetRxPhyMask_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
#endif /* defined(GP_COMP_GPTEST_BLE) */
gpMarshall_AckStatus_t gpTest_GetCapacitorLoad_Input_buf2api(gpTest_GetCapacitorLoad_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetCapacitorLoad_Output_api2buf(UInt8Buffer* pDest , gpTest_GetCapacitorLoad_Output_marshall_struct_t* pSourceoutput , gpTest_GetCapacitorLoad_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
void gpTest_GetSizeOfCapacitorLoad_Output_api2buf(UInt8Buffer* pDest , gpTest_GetSizeOfCapacitorLoad_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
...
void gpTest_SetNumberOfRetries_Output_buf2par(gpTest_Result_t* result , UInt8 retries , UInt8Buffer* pSource , UInt16* pIndex);
...
#endif /* defined(GP_COMP_GPTEST_BLE) */
#if defined(GP_COMP_GPTEST_BLE) 
void gpTest_BleGetNumberOfRxPackets_v2_Input_par2buf(UInt8Buffer* pDest , gpTest_AntennaSelection_t antenna , UInt16* pIndex);
void gpTest_BleGetNumberOfRxPackets_v2_Output_buf2par(UInt16* gpTest_NumberOfRxPackets , gpTest_AntennaSelection_t antenna , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_COMP_GPTEST_BLE) && !(defined(GP_DIVERSITY_GPHAL_K8A) || defined(GP_DIVERSITY_GPHAL_K8C) || defined(GP_DIVERSITY_GPHAL_K8D) || defined(GP_DIVERSITY_GPHAL_K8E)) */
#if defined(GP_COMP_GPTEST_BLE)
...
void gpTest_GetRxModeOptions_Output_buf2par(gpTest_Result_t* result , Bool* enableMultiStandard , Bool* enableMultiChannel , Bool* enableHighSensitivity , UInt8Buffer* pSource , UInt16* pIndex);
...
void gpTest_IsLowTemp_Output_buf2par(Bool* lowTemp , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_Xtal32MHzTrimGetZoneMaxTemp_Input_par2buf(UInt8Buffer* pDest , UInt8 zoneId , UInt16* pIndex);
void gpTest_Xtal32MHzTrimGetZoneMaxTemp_Output_buf2par(UInt8* gpTest_Result_t , UInt8 zoneId , Int8* pOutMaxTemp , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_Xtal32MHzTrimGetZoneSetting_Input_par2buf(UInt8Buffer* pDest , UInt8 zoneId , UInt16* pIndex);
void gpTest_Xtal32MHzTrimGetZoneSetting_Output_buf2par(UInt8* gpTest_Result_t , UInt8 zoneId , UInt8* pOutSetting , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_Xtal32MHzTrimConfigOverwrite_Input_par2buf(UInt8Buffer* pDest , Int8* pInMaxTempTab , UInt8* pInSettigTab , UInt8 zoneCnt , UInt16* pIndex);
void gpTest_Xtal32MHzTrimConfigOverwrite_Output_buf2par(UInt8* gpTest_Result_t , Int8* pInMaxTempTab , UInt8* pInSettigTab , UInt8 zoneCnt , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_SetTxPowerChannel_Input_par2buf(UInt8Buffer* pDest , UInt8 channel , Int8 transmitPower , UInt16* pIndex);
void gpTest_SetTxPowerChannel_Output_buf2par(gpTest_Result_t* result , UInt8 channel , Int8 transmitPower , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetTxPowerChannel_Input_par2buf(UInt8Buffer* pDest , UInt8 channel , UInt16* pIndex);
void gpTest_GetTxPowerChannel_Output_buf2par(gpTest_Result_t* result , UInt8 channel , Int8* pTransmitPower , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetStatisticsForChannel_Input_par2buf(UInt8Buffer* pDest , UInt8 channel , UInt16* pIndex);
void gpTest_GetStatisticsForChannel_Output_buf2par(gpTest_Result_t* result , gpTest_Statistics_t* pStatistics , UInt8 channel , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_ResetStatisticsForChannel_Input_par2buf(UInt8Buffer* pDest , UInt8 channel , UInt16* pIndex);
void gpTest_ResetStatisticsForChannel_Output_buf2par(gpTest_Result_t* result , UInt8 channel , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetLQIForChannel_Input_par2buf(UInt8Buffer* pDest , UInt8 channel , UInt16* pIndex);
void gpTest_GetLQIForChannel_Output_buf2par(gpTest_Result_t* result , UInt8 channel , UInt8* pLqi , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetRSSIForChannel_Input_par2buf(UInt8Buffer* pDest , UInt8 channel , UInt16* pIndex);
void gpTest_GetRSSIForChannel_Output_buf2par(gpTest_Result_t* result , UInt8 channel , Int8* pRssi , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetAntennaStatistics_Output_buf2par(gpTest_AntennaStatistics_t* pAnt0Statistics , gpTest_AntennaStatistics_t* pAnt1Statistics , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetChipTemperature_Output_buf2par(Int16* temp , UInt8Buffer* pSource , UInt16* pIndex);
#if defined(GP_DIVERSITY_GPHAL_XP4002)
void gpTest_SetDcdcMode_Input_par2buf(UInt8Buffer* pDest , Bool dcdcOn , UInt16* pIndex);
#endif /* defined(GP_DIVERSITY_GPHAL_XP4002) */
#if defined(GP_DIVERSITY_GPHAL_XP4002)
void gpTest_GetDcdcMode_Output_buf2par(gpTest_Result_t* result , hal_StandbyPowerMode_t* pStandbyPowerMode , hal_ActivePowerMode_t* pActivePowerMode , hal_SleepMode_t* pSleepMode , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_DIVERSITY_GPHAL_XP4002) */
#if defined(GP_COMP_GPTEST_BLE)
void gpTest_SetTxModulation_Input_par2buf(UInt8Buffer* pDest , gpTest_BleTxPhy_t modulation , UInt16* pIndex);
#endif /* defined(GP_COMP_GPTEST_BLE) */
#if defined(GP_COMP_GPTEST_BLE)
void gpTest_SetRxPhyMask_Input_par2buf(UInt8Buffer* pDest , UInt8 rxPhyMask , UInt16* pIndex);
void gpTest_SetRxPhyMask_Output_buf2par(gpTest_Result_t* result , UInt8 rxPhyMask , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_COMP_GPTEST_BLE) */
void gpTest_GetCapacitorLoad_Input_par2buf(UInt8Buffer* pDest , UInt8 tempIndex , UInt16* pIndex);
void gpTest_GetCapacitorLoad_Output_buf2par(Int16* temp , UInt8 tempIndex , UInt8Buffer* pSource , UInt16* pIndex);
void gpTest_GetSizeOfCapacitorLoad_Output_buf2par(UInt8* size , UInt8Buffer* pSource , UInt16* pIndex);
