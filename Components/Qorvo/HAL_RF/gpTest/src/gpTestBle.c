 ...
 *****************************************************************************/
void gpTest_BleSetAntennaDiversity(Bool OnOff)
{
    if(OnOff == true)
    {
...
Bool gpTest_BleGetAntennaDiversity(void)
{
...
UInt16 gpTest_BleGetNumberOfRxPackets_v2(gpTest_AntennaSelection_t antenna)
{
    return gpBleTest_GetNumberOfRxPackets_v2(antenna);
}
#endif
...
void gpTest_BleSetTxModulation(gpTest_BleTxPhy_t modulation)
{
