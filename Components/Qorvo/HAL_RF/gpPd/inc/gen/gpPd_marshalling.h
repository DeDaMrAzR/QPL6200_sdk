...
typedef struct {
    gpPd_Handle_t pdHandle;
} gpPd_GetTxAckRssi_Input_struct_t;

typedef struct {
    gpPd_GetTxAckRssi_Input_struct_t data;
} gpPd_GetTxAckRssi_Input_marshall_struct_t;

typedef struct {
    gpPd_Rssi_t ackRssi;
} gpPd_GetTxAckRssi_Output_struct_t;

typedef struct {
    gpPd_GetTxAckRssi_Output_struct_t data;
} gpPd_GetTxAckRssi_Output_marshall_struct_t;
...
typedef union {
    ...
    gpPd_GetTxAckRssi_Input_marshall_struct_t gpPd_GetTxAckRssi;
...
typedef union {
    ...
    gpPd_GetTxAckRssi_Output_marshall_struct_t gpPd_GetTxAckRssi;
    UInt8 dummy; //ensure none empty union definition
...
gpMarshall_AckStatus_t gpPd_GetTxAckRssi_Input_buf2api(gpPd_GetTxAckRssi_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpPd_GetTxAckRssi_Output_api2buf(UInt8Buffer* pDest , gpPd_GetTxAckRssi_Output_marshall_struct_t* pSourceoutput , gpPd_GetTxAckRssi_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
...
void gpPd_GetTxAckRssi_Input_par2buf(UInt8Buffer* pDest , gpPd_Handle_t pdHandle , UInt16* pIndex);
void gpPd_GetTxAckRssi_Output_buf2par(gpPd_Rssi_t* ackRssi , gpPd_Handle_t pdHandle , UInt8Buffer* pSource , UInt16* pIndex);
