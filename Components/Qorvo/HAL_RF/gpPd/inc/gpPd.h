...
/** @brief  Return the RSSI of the ACK of a transmitted packet.
 *
 *  @param  pdHandle    Handle associated with the packet.
 *  @return rssi        RSSI value of the ACK.
 */
gpPd_Rssi_t gpPd_GetTxAckRssi(gpPd_Handle_t pdHandle);
...
/** @brief Function to set the RSSI of the ACK for a transmitted packet.
 *
 *  @param pdHandle Handle associated with the packet.
 *  @param rssi     RSSI value of the ACK.
 */
void gpPd_SetTxAckRssi(gpPd_Handle_t pdHandle, gpPd_Rssi_t rssi);

/** @brief Function to set the LQI of the ACK for a transmitted packet.
 *
 *  @param pdHandle Handle associated with the packet.
 *  @param lqi      LQI value of the ACK.
 */
void gpPd_SetTxAckLqi(gpPd_Handle_t pdHandle, gpPd_Lqi_t lqi);
