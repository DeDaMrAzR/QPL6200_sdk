...
/** @struct gpUpgrade_Metadata_t
 *  @brief Metadata structure for a bootloader.
 */
PACKED_PRE
typedef struct {
    UInt32 otaAddress;    /**< Address of the OTA image. */
    UInt32 bootAddress;   /**< Address of the image to be booted. */
    UInt32 wakeUpAddress; /**< Address of the image to be booted after exiting sleep mode. */
} PACKED_POST gpUpgrade_Metadata_t;
