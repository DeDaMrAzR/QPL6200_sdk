...
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
typedef struct {
    gpRandom_Result_t result;
} gpRandom_CTR_DRBG_Init_Output_struct_t;

typedef struct {
    gpRandom_CTR_DRBG_Init_Output_struct_t data;
} gpRandom_CTR_DRBG_Init_Output_marshall_struct_t;

#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */

#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
typedef struct {
    gpRandom_Result_t result;
} gpRandom_CTR_DRBG_Reseed_Output_struct_t;

typedef struct {
    gpRandom_CTR_DRBG_Reseed_Output_struct_t data;
} gpRandom_CTR_DRBG_Reseed_Output_marshall_struct_t;

#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */

#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
typedef struct {
    UInt32 nmbrRandomBytes;
} gpRandom_CTR_DRBG_Generate_Input_struct_t;

typedef struct {
    gpRandom_CTR_DRBG_Generate_Input_struct_t data;
} gpRandom_CTR_DRBG_Generate_Input_marshall_struct_t;

typedef struct {
    gpRandom_Result_t result;
    UInt8* pBuffer;
} gpRandom_CTR_DRBG_Generate_Output_struct_t;

typedef struct {
    gpRandom_CTR_DRBG_Generate_Output_struct_t data;
    UInt8 pBuffer[25];
} gpRandom_CTR_DRBG_Generate_Output_marshall_struct_t;
...
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
    gpRandom_CTR_DRBG_Generate_Input_marshall_struct_t gpRandom_CTR_DRBG_Generate;
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
...
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
    gpRandom_CTR_DRBG_Init_Output_marshall_struct_t gpRandom_CTR_DRBG_Init;
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
    gpRandom_CTR_DRBG_Reseed_Output_marshall_struct_t gpRandom_CTR_DRBG_Reseed;
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
    gpRandom_CTR_DRBG_Generate_Output_marshall_struct_t gpRandom_CTR_DRBG_Generate;
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
...
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
void gpRandom_CTR_DRBG_Init_Output_api2buf(UInt8Buffer* pDest , gpRandom_CTR_DRBG_Init_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
void gpRandom_CTR_DRBG_Reseed_Output_api2buf(UInt8Buffer* pDest , gpRandom_CTR_DRBG_Reseed_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
gpMarshall_AckStatus_t gpRandom_CTR_DRBG_Generate_Input_buf2api(gpRandom_CTR_DRBG_Generate_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpRandom_CTR_DRBG_Generate_Output_api2buf(UInt8Buffer* pDest , gpRandom_CTR_DRBG_Generate_Output_marshall_struct_t* pSourceoutput , gpRandom_CTR_DRBG_Generate_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
...
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
void gpRandom_CTR_DRBG_Init_Output_buf2par(gpRandom_Result_t* result , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
void gpRandom_CTR_DRBG_Reseed_Output_buf2par(gpRandom_Result_t* result , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
#if defined(GP_RANDOM_DIVERSITY_CTR_DRBG)
void gpRandom_CTR_DRBG_Generate_Input_par2buf(UInt8Buffer* pDest , UInt32 nmbrRandomBytes , UInt16* pIndex);
void gpRandom_CTR_DRBG_Generate_Output_buf2par(gpRandom_Result_t* result , UInt32 nmbrRandomBytes , UInt8* pBuffer , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_RANDOM_DIVERSITY_CTR_DRBG) */
