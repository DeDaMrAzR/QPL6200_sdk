...
#ifdef GP_DIVERSITY_LOG
// If __FILE_NANE don't exist for compiler, lets fall back on the full path __FILE__
#ifndef __FILE_NAME__
#define __FILE_NAME__ __FILE__
#endif //__FILE_NAME__
#if defined(__IAR_SYSTEMS_ICC__) && defined(GP_DIVERSITY_ROM_CODE) && defined(GP_DIVERSITY_JUMPTABLES)
static const char ROM gpFileName[] FLASH_PROGMEM @ ".rom" = {XSTRINGIFY(__FILE_NAME__)};
#define GP_ASSERT_FILENAME gpFileName
#else
#define GP_ASSERT_FILENAME GP_ASSERT_PSTR(__FILE_NAME__)
#endif
#else
