...
#ifdef GP_LOG_DIVERSITY_DEVELOPMENT_FORCE_FLUSH
    if(gpCom_GetFreeBufferSpace(GP_COMPONENT_ID_LOG, GP_LOG_COMMUNICATION_ID) < nbr_chars+1)
    {
        gpCom_Flush();
    }
#endif //GP_LOG_DIVERSITY_DEVELOPMENT_FORCE_FLUSH
