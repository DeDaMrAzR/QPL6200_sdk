...
#ifdef GP_COMP_HALPLATFORM
#include "hal_SupplyVoltageMonitor.h"
#endif // GP_COMP_HALPLATFORM
#endif // defined(GP_DIVERSITY_GPHAL_XP4002)

#if defined(GP_DIVERSITY_FREERTOS) && defined(GP_FREERTOS_DIVERSITY_TRACE_TASKS)
...
#if defined(GP_COMP_PAD) 
    gpPad_Init();
#endif // GP_COMP_PAD && !defined(GP_PAD_AS_INTERFACE)
