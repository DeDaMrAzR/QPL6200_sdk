 ...
 *
 *
 *   QPG6200 PTC 10DBM Single Ended UART 10 to 11
 *
...
#ifndef _GPBSP_PTC_QPG6200_QFN32_10DBM_UART10TO11_H_
#define _GPBSP_PTC_QPG6200_QFN32_10DBM_UART10TO11_H_
...
// Pin 28 - GPIO 11 - UART0_RX
#define GP_BSP_UART0_RX_GPIO                        11
#define GP_BSP_UART0_RX_ALTERNATE                   GP_WB_ENUM_GPIO_11_ALTERNATES_UART_0_RX
#define GP_BSP_UART0_RX_INIT()                      do{ GP_WB_WRITE_IOB_GPIO_11_ALTERNATE(GP_WB_ENUM_GPIO_11_ALTERNATES_UART_0_RX); GP_WB_WRITE_IOB_GPIO_11_ALTERNATE_ENABLE(1); }while(0)
#define GP_BSP_UART0_RX_DEINIT()                    GP_WB_WRITE_IOB_GPIO_11_ALTERNATE_ENABLE(0);
#define GP_BSP_UART0_RX_DEFINED()                   (1)
#define GP_BSP_UART0_RX_GPIO_CFG()                  do{ \
    GP_WB_WRITE_IOB_GPIO_11_PULL_MODE(1); \
    GP_WB_WRITE_IOB_GPIO_11_PULL_ENABLE(1); \
}while(0)
#define GP_BSP_UART0_RX_ENABLE(en)                  do{ if (en) { GP_WB_WRITE_IOB_GPIO_11_ALTERNATE(GP_WB_ENUM_GPIO_11_ALTERNATES_UART_0_RX); } GP_WB_WRITE_IOB_GPIO_11_ALTERNATE_ENABLE((en)); }while(0)
#define GP_BSP_UART0_RX_ENABLED()                   GP_WB_READ_IOB_GPIO_11_ALTERNATE_ENABLE()

// Pin 27 - GPIO 10 - UART0_TX
#define GP_BSP_UART0_TX_GPIO                        10
#define GP_BSP_UART0_TX_ALTERNATE                   GP_WB_ENUM_GPIO_10_ALTERNATES_UART_0_TX
#define GP_BSP_UART0_TX_INIT()                      do{ GP_WB_WRITE_IOB_GPIO_10_ALTERNATE(GP_WB_ENUM_GPIO_10_ALTERNATES_UART_0_TX); GP_WB_WRITE_IOB_GPIO_10_ALTERNATE_ENABLE(1); }while(0)
#define GP_BSP_UART0_TX_DEINIT()                    GP_WB_WRITE_IOB_GPIO_10_ALTERNATE_ENABLE(0);
#define GP_BSP_UART0_TX_DEFINED()                   (1)
#define GP_BSP_UART0_TX_GPIO_CFG()                  do{ \
    GP_WB_WRITE_IOB_GPIO_10_PULL_MODE(0); \
    GP_WB_WRITE_IOB_GPIO_10_PULL_ENABLE(0); \
}while(0)
#define GP_BSP_UART0_TX_ENABLE(en)                  do{ if (en) { GP_WB_WRITE_IOB_GPIO_10_ALTERNATE(GP_WB_ENUM_GPIO_10_ALTERNATES_UART_0_TX); } GP_WB_WRITE_IOB_GPIO_10_ALTERNATE_ENABLE((en)); }while(0)
#define GP_BSP_UART0_TX_ENABLED()                   GP_WB_READ_IOB_GPIO_10_ALTERNATE_ENABLE()
...
#define GP_BSP_UART_TX_GPIO_MAP                     { 10, 0xff, 0xff }
#define GP_BSP_UART_TX_ALTERNATE_MAP                { GP_WB_ENUM_GPIO_10_ALTERNATES_UART_0_TX, 0, 0 }
#define GP_BSP_UART_RX_GPIO_MAP                     { 11, 0xff, 0xff }
#define GP_BSP_UART_RX_ALTERNATE_MAP                { GP_WB_ENUM_GPIO_11_ALTERNATES_UART_0_RX, 0, 0 }
...
#define GP_BSP_GENERIC_INIT()                       do{ \
    ...
    GP_WB_WRITE_IOB_GPIO_11_PULL_MODE(0); \
    GP_WB_WRITE_IOB_GPIO_11_PULL_ENABLE(0); \
...
#define GP_BSP_SLEEPMODENOTRETAINEDLIST_INIT()      do{ \
    GP_WB_WRITE_SYSRAM_RETAIN_UART_1(0); \
...
#endif //_GPBSP_PTC_QPG6200_QFN32_10DBM_UART10TO11_H_
