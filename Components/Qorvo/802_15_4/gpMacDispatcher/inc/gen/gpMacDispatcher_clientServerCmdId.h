...
#define gpMacDispatcher_GetRadioSensitivity_CmdId                    0xa7 /*167*/
#define gpMacDispatcher_GetCslAccuracy_CmdId                         0xa8 /*168*/
#define gpMacDispatcher_GetCslUncertainty_CmdId                      0xa9 /*169*/
