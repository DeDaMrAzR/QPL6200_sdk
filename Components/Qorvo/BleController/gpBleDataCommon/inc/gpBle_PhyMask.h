...
#define BLE_PHYMASK_CODED                               HCI_PHYMASK_INIT(GP_HCI_PHY_MASK_CODED)
        ...
        #define BLE_SUPPORTED_PHYS_MASK                         HCI_PHYMASK_INIT((GP_HCI_PHY_MASK_1MB | GP_HCI_PHY_MASK_2MB | GP_HCI_PHY_MASK_CODED))
        #define BLE_MAX_PHYS                                    (3)
    #else
        #define BLE_SUPPORTED_PHYS_MASK                         HCI_PHYMASK_INIT((GP_HCI_PHY_MASK_1MB | GP_HCI_PHY_MASK_CODED))
