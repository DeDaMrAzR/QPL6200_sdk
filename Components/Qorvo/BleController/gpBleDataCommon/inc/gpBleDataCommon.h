...
#define GPBLEDATACOMMON_TIME_SUPPORTED_MAX      gpBleDataCommon_GetPacketDurationUs(GPBLEDATACOMMON_OCTETS_SUPPORTED_MAX, gpHci_PhyWithCoding_Coded125kb, true)
#else
...
#define GPBLEDATACOMMON_GET_SUPPORTED_PHYS_MASK()       HCI_PHYMASK_INIT((GP_HCI_PHY_MASK_1MB | GP_HCI_PHY_MASK_2MB | GP_HCI_PHY_MASK_CODED))
#else
#define GPBLEDATACOMMON_GET_SUPPORTED_PHYS_MASK()       HCI_PHYMASK_INIT((GP_HCI_PHY_MASK_1MB | GP_HCI_PHY_MASK_CODED))
...
#ifdef GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
void gpBleDataCommon_SetConnectionIntervalOverrule(Ble_IntConnId_t connId, UInt16 intervalUnit);
#endif //GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
