...
static gpHci_Result_t Ble_SetCodedPhyCodingHelper(gpHci_CommandParameters_t* pParams, gpBle_EventBuffer_t* pEventBuf);
...
#ifdef GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
gpHci_Result_t Ble_SetCodedPhyCodingHelper(gpHci_CommandParameters_t* pParams, gpBle_EventBuffer_t* pEventBuf)
{
    BLE_SET_RESPONSE_EVENT_COMMAND_COMPLETE(pEventBuf->eventCode);

    return gpBleConfig_SetPreferredCodedPhyCoding((gpHci_PhyWithCoding_t)pParams->SetVsdTestParams.value[0]);
}
#endif //GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
...
#ifdef GP_DIVERSITY_DEVELOPMENT
#ifdef GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
        case gpBle_SetVsdPreferredCodedPhyCoding: return Ble_SetCodedPhyCodingHelper( pParams, pEventBuf);
#endif //GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
