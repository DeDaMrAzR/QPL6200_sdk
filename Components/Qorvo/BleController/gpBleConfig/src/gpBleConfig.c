...
// Octet 6
#define BLE_CMD_READ_CONNECTION_ACCEPT_TIMEOUT          (1 << 2)
#define BLE_CMD_WRITE_CONNECTION_ACCEPT_TIMEOUT         (1 << 3)
// Octet 10
...
#define BLE_LL_FEATURE_ISO_BROADCASTER                          BM(gpBleConfig_FeatureIdIsochronousBroadcaster)
...
typedef struct {
    ...
    gpHci_PhyWithCoding_t preferredCodedPhyCoding;
...
static UInt8 BleConfig_SupportedCommands[BLECONFIG_SUPPORTED_COMMANDS_LENGTH];
...
static void BleConfig_InitSupportedCommands(void);
...
#ifdef GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
    Ble_LocalSupportedFeatures |= BLE_LL_FEATURE_CODED_PHY_MASK;
#endif //GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
...
void BleConfig_InitSupportedCommands(void)
{
    MEMSET(BleConfig_SupportedCommands, 0, sizeof(BleConfig_SupportedCommands));

    BleConfig_SupportedCommands[00] |= (BLE_CMD_DISCONNECT);

    BleConfig_SupportedCommands[02] |= (BLE_CMD_READ_REM_VERSION);
    BleConfig_SupportedCommands[05] |= (BLE_CMD_SET_EVENT_MASK | BLE_CMD_RESET);


    BleConfig_SupportedCommands[10] |= (BLE_CMD_READ_TX_POWER_LEVEL);

    BleConfig_SupportedCommands[14] |= (BLE_CMD_READ_LOCAL_VERSION_INFO | BLE_CMD_READ_LOCAL_SUPP_FEATURES);

    BleConfig_SupportedCommands[15] |= (BLE_CMD_READ_BD_ADDRESS | BLE_CMD_READ_RSSI);

    BleConfig_SupportedCommands[22] |= (BLE_CMD_SET_EVENT_MASK_PAGE2);

    BleConfig_SupportedCommands[25] |= BLE_CMD_LE_SET_EVENT_MASK;
    BleConfig_SupportedCommands[25] |= BLE_CMD_LE_READ_BUFFER_SIZE;
    BleConfig_SupportedCommands[25] |= BLE_CMD_LE_READ_LOCAL_SUPP_FEATURES;
    BleConfig_SupportedCommands[25] |= BLE_CMD_LE_SET_RANDOM_ADDRESS;
    BleConfig_SupportedCommands[25] |= BLE_CMD_LE_SET_ADV_PARAMS;
    BleConfig_SupportedCommands[25] |= BLE_CMD_READ_ADV_CHANNEL_TX_POWER;
    BleConfig_SupportedCommands[25] |= BLE_CMD_LE_SET_ADV_DATA;

    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_SET_SCAN_RSP_DATA;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_SET_ADV_ENABLE;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_SET_SCAN_PARAMS;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_SET_SCAN_ENABLE;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_CREATE_CONNECTION;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_CREATE_CONNECTION_CANCEL;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_READ_FILTER_ACCEPT_LIST_SIZE;
    BleConfig_SupportedCommands[26] |= BLE_CMD_LE_CLEAR_FILTER_ACCEPT_LIST;

    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_ADD_DEV_TO_FILTER_ACCEPT_LIST;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_REMOVE_DEV_FROM_FILTER_ACCEPT_LIST;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_CONNECTION_UPDATE;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_SET_HOST_CHAN_CLASSIFICATION;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_READ_CHANNEL_MAP;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_READ_REMOTE_FEATURES;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_ENCRYPT;
    BleConfig_SupportedCommands[27] |= BLE_CMD_LE_RAND;

    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_START_ENCRYPTION;
    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_LTK_REQUEST_REPLY;
    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_LTK_REQUEST_NEG_REPLY;
    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_READ_SUPPORTED_STATES;
    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_RECEIVER_TEST;
    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_TRANSMITTER_TEST;
    BleConfig_SupportedCommands[28] |= BLE_CMD_LE_TEST_END;

    BleConfig_SupportedCommands[32] |= BLE_CMD_READ_AUTH_PAYLOAD_TO;
    BleConfig_SupportedCommands[32] |= BLE_CMD_WRITE_AUTH_PAYLOAD_TO;

    BleConfig_SupportedCommands[33] |= BLE_CMD_LE_REM_CONN_PARAM_REQ_REPLY;
    BleConfig_SupportedCommands[33] |= BLE_CMD_LE_REM_CONN_PARAM_REQ_NEG_REPLY;
    BleConfig_SupportedCommands[33] |= BLE_CMD_LE_SET_DATA_LENGTH;
    BleConfig_SupportedCommands[33] |= BLE_CMD_LE_READ_SUG_DEF_DATA_LENGTH;

    BleConfig_SupportedCommands[34] |= BLE_CMD_LE_WRITE_SUG_DEF_DATA_LENGTH;

    BleConfig_SupportedCommands[35] |= BLE_CMD_LE_READ_MAX_DATA_LENGTH;
    BleConfig_SupportedCommands[35] |= BLE_CMD_LE_READ_PHY;
    BleConfig_SupportedCommands[35] |= BLE_CMD_LE_SET_DEFAULT_PHY;
    BleConfig_SupportedCommands[35] |= BLE_CMD_LE_SET_PHY;
    BleConfig_SupportedCommands[35] |= BLE_CMD_LE_ENHANCED_RECEIVER_TEST;


    BleConfig_SupportedCommands[36] |= BLE_CMD_LE_ENHANCED_TRANSMITTER_TEST;



#ifndef GP_DIVERSITY_BLE_DISABLE_LE_READ_TRANSMIT_POWER_CMD
    BleConfig_SupportedCommands[38] = BLE_CMD_LE_READ_TRANSMIT_POWER;
#endif

#ifndef GP_DIVERSITY_BLE_DISABLE_TESTV3_CMDS
    BleConfig_SupportedCommands[39] |= BLE_CMD_LE_RECEIVER_TEST_V3;
    BleConfig_SupportedCommands[39] |= BLE_CMD_LE_TRANSMITTER_TEST_V3;
#endif /* GP_DIVERSITY_BLE_DISABLE_TESTV3_CMDS */

#ifdef GP_DIVERSITY_DIRECTIONFINDING_SUPPORTED
    BleConfig_SupportedCommands[40] |= BLE_CMD_LE_SET_CONNECTION_CTE_RECEIVE_PARAMETERS;
    BleConfig_SupportedCommands[40] |= BLE_CMD_LE_SET_CONNECTION_CTE_TRANSMIT_PARAMETERS;
    BleConfig_SupportedCommands[40] |= BLE_CMD_LE_CONNECTION_CTE_REQUEST_ENABLE;
    BleConfig_SupportedCommands[40] |= BLE_CMD_LE_CONNECTION_CTE_RESPONSE_ENABLE;
    BleConfig_SupportedCommands[40] |= BLE_CMD_LE_READ_ANTENNA_INFORMATION;
#endif //GP_DIVERSITY_DIRECTIONFINDING_SUPPORTED
...
{
    BleConfig_InitSupportedCommands();
...
#ifdef GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
    Ble_ConfigContext.preferredCodedPhyCoding = gpHci_PhyWithCoding_Coded125kb;
#endif //GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
}
...
#ifdef GP_DIVERSITY_BLE_CODED_PHY_SUPPORTED
gpHci_Result_t gpBleConfig_SetPreferredCodedPhyCoding(gpHci_PhyWithCoding_t phyWithCoding)
{
    if(phyWithCoding != gpHci_PhyWithCoding_Coded125kb && phyWithCoding != gpHci_PhyWithCoding_Coded500kb)
    {
        return gpHci_ResultInvalidHCICommandParameters;
    }

    Ble_ConfigContext.preferredCodedPhyCoding = phyWithCoding;

    return gpHci_ResultSuccess;
}

gpHci_PhyWithCoding_t gpBleConfig_GetPreferredCodedPhyCoding(void)
{
    return Ble_ConfigContext.preferredCodedPhyCoding;
}
...
Bool gpBleConfig_IsLeMetaEventMasked(gpHci_LeMetaSubEventCode_t event)
{
    ...
    return BIT_TST64(Ble_ConfigContext.leEventMask, (event - 1));
}

Bool gpBleConfig_IsLeMetaVSDEventMasked(gpHci_VsdMetaSubEventCode_t event)
{
...
#if defined(GP_DIVERSITY_BLE_DISABLE_LE_READ_TRANSMIT_POWER_CMD)
    result = gpHci_ResultUnknownHCICommand;
    return result;
#endif // GP_DIVERSITY_BLE_DISABLE_LE_READ_TRANSMIT_POWER_CMD
    result = gpHci_ResultSuccess;
...
static Bool BleConfig_IsPowerClass1(void)
{
     ...
     * In some variants maxTxPower = 10dBm can be class1 as the power at antenna connector can still be > 10dBm
