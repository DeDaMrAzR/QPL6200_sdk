...
} gpBleTest_GetNumberOfRxPackets_v2_Input_struct_t;

typedef struct {
    gpBleTest_GetNumberOfRxPackets_v2_Input_struct_t data;
} gpBleTest_GetNumberOfRxPackets_v2_Input_marshall_struct_t;

typedef struct {
    UInt16 gpTest_NumberOfRxPackets;
} gpBleTest_GetNumberOfRxPackets_v2_Output_struct_t;

typedef struct {
    gpBleTest_GetNumberOfRxPackets_v2_Output_struct_t data;
} gpBleTest_GetNumberOfRxPackets_v2_Output_marshall_struct_t;
...
typedef union {
    ...
    gpBleTest_GetNumberOfRxPackets_v2_Input_marshall_struct_t gpBleTest_GetNumberOfRxPackets_v2;
...
typedef union {
    ...
    gpBleTest_GetNumberOfRxPackets_v2_Output_marshall_struct_t gpBleTest_GetNumberOfRxPackets_v2;
...
gpMarshall_AckStatus_t gpBleTest_GetNumberOfRxPackets_v2_Input_buf2api(gpBleTest_GetNumberOfRxPackets_v2_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpBleTest_GetNumberOfRxPackets_v2_Output_api2buf(UInt8Buffer* pDest , gpBleTest_GetNumberOfRxPackets_v2_Output_marshall_struct_t* pSourceoutput , gpBleTest_GetNumberOfRxPackets_v2_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
...
void gpBleTest_GetNumberOfRxPackets_v2_Input_par2buf(UInt8Buffer* pDest , gpBleTest_AntennaSelection_t antenna , UInt16* pIndex);
void gpBleTest_GetNumberOfRxPackets_v2_Output_buf2par(UInt16* gpTest_NumberOfRxPackets , gpBleTest_AntennaSelection_t antenna , UInt8Buffer* pSource , UInt16* pIndex);
