...
typedef struct gpBleTest_Config_s
{
    ...
    UInt16 numberOfRxPacketsAnt0;
    UInt16 numberOfRxPacketsAnt1;
...
void gpBleTest_Start(void)
{
    ...
    gpBleTest_Config.blePhysicalChannel = 0;
    gpBleTest_Config.txPhy = gpHal_BleTxPhy1Mb;
    gpBleTest_Config.bleRxPhyMask = BleMask_Init(gpHci_Phy_1Mb);
...
UInt16 gpBleTest_GetNumberOfRxPackets_v2(gpBleTest_AntennaSelection_t antenna)
{
    switch(antenna)
    {
        case gpHal_AntennaSelection_Ant0:
            return gpBleTest_Config.numberOfRxPacketsAnt0;
            break;
        case gpHal_AntennaSelection_Ant1:
            return gpBleTest_Config.numberOfRxPacketsAnt1;
            break;
        default:
            return gpBleTest_Config.numberOfRxPacketsAnt0 + gpBleTest_Config.numberOfRxPacketsAnt1;
            break;
    }
}
...
UInt16 gpBleTest_TestEnd(void)
{
    ...
    {
        gpHal_BleTestModeRxPackets_t rxPackets;
        gpHal_BleTestModeGetRxPackets(&rxPackets);
        gpBleTest_Config.numberOfRxPacketsAnt0 = rxPackets.ant0;
        gpBleTest_Config.numberOfRxPacketsAnt1 = rxPackets.ant1;
    }
