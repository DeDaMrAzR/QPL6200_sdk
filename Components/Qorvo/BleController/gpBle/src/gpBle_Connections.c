...
void gpBle_SendHciNumberOfCompletedPacketsEvent(gpHci_ConnectionHandle_t connHandle, UInt8 NumCompletedCount)
{
    ...
    pEventBuf->payload.numberOfCompletedPackets.nrOfHciPackets = NumCompletedCount;
