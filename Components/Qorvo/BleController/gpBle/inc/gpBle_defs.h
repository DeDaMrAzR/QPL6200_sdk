...
#define GPBLE_ACCESS_ADDRESS_INVALID                    0xFFFFFFFF
...
// Macro's to set/get fields in a 16bit connection handle (which can also include additional status flags)
...
#define BLE_CONN_HANDLE_ISO_TS_GET(handle)               BLE_BM_GET(handle, BLE_CONN_HANDLE_ISO_TS_BM, BLE_CONN_HANDLE_ISO_TS_IDX)
...
#define Ble_Priority_VeryLow        GPHAL_BLE_PRIORITY_VERYLOW
#define Ble_Priority_Low            GPHAL_BLE_PRIORITY_LOW
#define Ble_Priority_Medium         GPHAL_BLE_PRIORITY_MEDIUM
#define Ble_Priority_High           GPHAL_BLE_PRIORITY_HIGH
#define Ble_Priority_VeryHigh       GPHAL_BLE_PRIORITY_VERYHIGH
...
#define GPBLEACTIVITYMANAGER_ACTIVITY_ID_BIG_START     0xB0
#define GPBLEACTIVITYMANAGER_ACTIVITY_ID_BIG_END       0xBF
...
void gpBle_ReadChannelMapFromPdu(gpPd_Loh_t* pPdLoh, gpHci_ChannelMap_t* pChannelMap);
void gpBle_ReadConnectIndFromPd(gpPd_Loh_t* pPdLoh, Ble_ConnReqPdu_t* pConnReq);
...
Bool gpBle_IsIntervalMultipleOf1250Us(UInt32 intervalUs);
