...
#endif /* defined(GP_DIVERSITY_BLE_CENTRAL) || defined(GP_DIVERSITY_BLE_PERIPHERAL) */
#if defined(GP_DIVERSITY_BLE_ACL_CONNECTIONS_SUPPORTED)
...
#endif /* defined(GP_DIVERSITY_BLE_ACL_CONNECTIONS_SUPPORTED) */
#if defined(GP_DIVERSITY_BLE_PERIPHERAL)
...
#endif /* defined(GP_DIVERSITY_BLE_DIRECTTESTMODE_SUPPORTED) */
#if defined(GP_DIVERSITY_BLE_PHY_UPDATE_SUPPORTED) && defined(GP_DIVERSITY_BLE_ACL_CONNECTIONS_SUPPORTED)
...
#endif /* defined(GP_DIVERSITY_BLE_PHY_UPDATE_SUPPORTED) && defined(GP_DIVERSITY_BLE_ACL_CONNECTIONS_SUPPORTED) */
#if defined(GP_DIVERSITY_BLE_PHY_UPDATE_SUPPORTED) && defined(GP_DIVERSITY_BLE_ACL_CONNECTIONS_SUPPORTED)
...
#undef _enable
        ...
        {
#define _connHandle                                                   pPayload[0]
            MEMCPY(&command.VsdDisablePeripheralLatency.connHandle, &_connHandle, sizeof(gpHci_ConnectionHandle_t));
#undef _connHandle
#define _disabled                                                     pPayload[0 + 2*1]
            command.VsdDisablePeripheralLatency.disabled = _disabled;
#undef _disabled
            function = gpBle_VsdDisablePeripheralLatency;
            break;
        }
#endif /* defined(GP_DIVERSITY_BLE_CENTRAL) || defined(GP_DIVERSITY_BLE_PERIPHERAL) */
#if defined(GP_DIVERSITY_BLE_PERIPHERAL)
...
#endif /* defined(GP_DIVERSITY_BLE_DIRECTTESTMODE_SUPPORTED) */
#if defined(GP_DIVERSITY_DEVELOPMENT)
        case gpHci_OpCodeVsdEnablePeriodicRfCalibration:
        {
#define _intervalMs                                                   pPayload[0]
            MEMCPY(&command.VsdEnablePeriodicRfCalibration.intervalMs, &_intervalMs, sizeof(UInt32));
#undef _intervalMs
            function = gpBle_VsdEnablePeriodicRfCalibration;
            break;
        }
#endif /* defined(GP_DIVERSITY_DEVELOPMENT) */
