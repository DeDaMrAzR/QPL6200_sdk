...
{
#if defined(GP_HCI_DIVERSITY_HOST_SERVER) || defined(GP_HCI_DIVERSITY_GPCOM_SERVER)
...
#endif // defined(GP_HCI_DIVERSITY_HOST_SERVER) || defined(GP_HCI_DIVERSITY_GPCOM_SERVER)
