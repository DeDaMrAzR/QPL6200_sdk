...
#define gpHci_OpCodeLeCreateBig                                                0x2068
#define gpHci_OpCodeLeCreateBigTest                                            0x2069
#define gpHci_OpCodeLeTerminateBig                                             0x206A
#define gpHci_OpCodeLeBigCreateSync                                            0x206B
#define gpHci_OpCodeLeBigTerminateSync                                         0x206C
...
#define gpHci_OpCodeVsdDisablePeripheralLatency                                0xFC0C
...
#define gpHci_OpCodeVsdEnablePeriodicRfCalibration                             0xFC2A
#define gpHci_OpCodeVsdSetDirectTestModeTxData                                 0xFC2B
