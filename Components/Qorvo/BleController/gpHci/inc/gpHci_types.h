...
/** @enum gpHci_VsdMetaSubEventCode_t */
//@{
typedef UInt8                             gpHci_VsdMetaSubEventCode_t;
//@}
...
/** @enum gpHci_Encryption_t */
//@{
#define gpHci_EncryptionStatusUnencrypted                      0x00
#define gpHci_EncryptionStatusEncrypted                        0x01
#define gpHci_EncryptionStatusInvalid                          0x02
typedef UInt8                             gpHci_Encryption_t;
//@}
...
/** @macro GP_HCI_BIS_BROADCAST_CODE_LENGTH */
#define GP_HCI_BIS_BROADCAST_CODE_LENGTH             16
/** @macro GP_HCI_OGF_LC */
/** @brief Link Control */
...
/** @macro GP_HCI_HANDLE_SPEC_MIN */
#define GP_HCI_HANDLE_SPEC_MIN                       0x00
/** @macro GP_HCI_HANDLE_SPEC_MAX */
#define GP_HCI_HANDLE_SPEC_MAX                       0xEF
/** @macro GP_HCI_HANDLE_SPEC_INVALID */
#define GP_HCI_HANDLE_SPEC_INVALID                   0xF0
/** @macro GP_HCI_ADV_HANDLE_SPEC_MIN */
#define GP_HCI_ADV_HANDLE_SPEC_MIN                   0x00
/** @macro GP_HCI_ADV_HANDLE_SPEC_MAX */
#define GP_HCI_ADV_HANDLE_SPEC_MAX                   0xEF
/** @macro GP_HCI_ADV_HANDLE_SPEC_INVALID */
#define GP_HCI_ADV_HANDLE_SPEC_INVALID               0xF0
/** @macro GP_HCI_IG_ID_SPEC_MIN */
/** @brief IG: Isochronous Group; IS: Isochronous Stream. These are applicable to both BIG/BIS and CIG/CIS */
#define GP_HCI_IG_ID_SPEC_MIN                        0x00
/** @macro GP_HCI_IG_ID_SPEC_MAX */
#define GP_HCI_IG_ID_SPEC_MAX                        0xEF
/** @macro GP_HCI_IG_ID_SPEC_INVALID */
#define GP_HCI_IG_ID_SPEC_INVALID                    0xF0
/** @macro GP_HCI_IS_ID_SPEC_MIN */
#define GP_HCI_IS_ID_SPEC_MIN                        0x00
/** @macro GP_HCI_IS_ID_SPEC_MAX */
#define GP_HCI_IS_ID_SPEC_MAX                        0xEF
/** @macro GP_HCI_IS_ID_SPEC_INVALID */
#define GP_HCI_IS_ID_SPEC_INVALID                    0xF0
/** @macro GP_HCI_SYNC_HANDLE_SPEC_MAX */
#define GP_HCI_SYNC_HANDLE_SPEC_MAX                  0x0EFF
/** @macro GP_HCI_SYNC_HANDLE_SPEC_INVALID */
#define GP_HCI_SYNC_HANDLE_SPEC_INVALID              0x0F00
/** @macro GP_HCI_CIG_CIS_COUNT_MIN */
#define GP_HCI_CIG_CIS_COUNT_MIN                     0x00
/** @macro GP_HCI_CIG_CIS_COUNT_MAX */
#define GP_HCI_CIG_CIS_COUNT_MAX                     0x1F
...
/** @macro GP_HCI_SDU_INTERVAL_SPEC_INVALID */
#define GP_HCI_SDU_INTERVAL_SPEC_INVALID             0xFFFFFFFF
...
/** @macro GP_HCI_SDU_SIZE_SPEC_INVALID */
#define GP_HCI_SDU_SIZE_SPEC_INVALID                 0xFFFF
...
/** @macro GP_HCI_ISO_RTN_SPEC_MIN */
#define GP_HCI_ISO_RTN_SPEC_MIN                      0x00
/** @macro GP_HCI_ISO_RTN_SPEC_MAX */
#define GP_HCI_ISO_RTN_SPEC_MAX                      0x1E
/** @macro GP_HCI_ISO_RTN_SPEC_INVALID */
#define GP_HCI_ISO_RTN_SPEC_INVALID                  0x1F
/** @macro GP_HCI_ISO_INTERVAL_SPEC_MIN */
#define GP_HCI_ISO_INTERVAL_SPEC_MIN                 0x0004
/** @macro GP_HCI_ISO_INTERVAL_SPEC_MAX */
#define GP_HCI_ISO_INTERVAL_SPEC_MAX                 0x0C80
/** @macro GP_HCI_ISO_INTERVAL_SPEC_INVALID */
#define GP_HCI_ISO_INTERVAL_SPEC_INVALID             0x0C81
/** @macro GP_HCI_ISO_NSE_SPEC_MIN */
#define GP_HCI_ISO_NSE_SPEC_MIN                      0x01
/** @macro GP_HCI_ISO_NSE_SPEC_MAX */
#define GP_HCI_ISO_NSE_SPEC_MAX                      0x1F
/** @macro GP_HCI_ISO_NSE_SPEC_INVALID */
#define GP_HCI_ISO_NSE_SPEC_INVALID                  0x20
/** @macro GP_HCI_BIS_BN_SPEC_MIN */
#define GP_HCI_BIS_BN_SPEC_MIN                       0x01
/** @macro GP_HCI_BIS_BN_SPEC_MAX */
#define GP_HCI_BIS_BN_SPEC_MAX                       0x07
/** @macro GP_HCI_BIS_BN_SPEC_INVALID */
#define GP_HCI_BIS_BN_SPEC_INVALID                   0x08
/** @macro GP_HCI_IRC_SPEC_MIN */
#define GP_HCI_IRC_SPEC_MIN                          0x01
/** @macro GP_HCI_IRC_SPEC_MAX */
#define GP_HCI_IRC_SPEC_MAX                          0x0F
/** @macro GP_HCI_IRC_SPEC_INVALID */
#define GP_HCI_IRC_SPEC_INVALID                      0x10
/** @macro GP_HCI_PTO_SPEC_MIN */
#define GP_HCI_PTO_SPEC_MIN                          0x00
/** @macro GP_HCI_PTO_SPEC_MAX */
#define GP_HCI_PTO_SPEC_MAX                          0x0F
/** @macro GP_HCI_PTO_SPEC_INVALID */
#define GP_HCI_PTO_SPEC_INVALID                      0x10
/** @macro GP_HCI_BIG_SYNC_TIMEOUT_SPEC_MIN */
#define GP_HCI_BIG_SYNC_TIMEOUT_SPEC_MIN             0x000A
/** @macro GP_HCI_BIG_SYNC_TIMEOUT_SPEC_MAX */
#define GP_HCI_BIG_SYNC_TIMEOUT_SPEC_MAX             0x4000
/** @macro GP_HCI_ISO_PDU_LENGTH_SPEC_MIN */
#define GP_HCI_ISO_PDU_LENGTH_SPEC_MIN               0x01
/** @macro GP_HCI_ISO_PDU_LENGTH_SPEC_MAX */
#define GP_HCI_ISO_PDU_LENGTH_SPEC_MAX               0xFB
/** @macro GP_HCI_ISO_PDU_LENGTH_SPEC_INVALID */
#define GP_HCI_ISO_PDU_LENGTH_SPEC_INVALID           0xFC
...
/** @macro GP_HCI_NSE_SPEC_MAX */
#define GP_HCI_NSE_SPEC_MAX                          31
/** @macro GP_HCI_NUMBIS_SPEC_MIN */
#define GP_HCI_NUMBIS_SPEC_MIN                       1
/** @macro GP_HCI_NUMBIS_SPEC_MAX */
#define GP_HCI_NUMBIS_SPEC_MAX                       31
/*****************************************************************************
...
typedef UInt8 gpHci_BigHandle_t;
...
/** @struct gpHci_LeReadRemoteFeaturesCompleteEventParams_t */
typedef struct {
    gpHci_Result_t                 status;
    gpHci_ConnectionHandle_t       connectionHandle;
    UInt8                          features[GP_HCI_FEATURE_SET_SIZE];
} gpHci_LeReadRemoteFeaturesCompleteEventParams_t;

/** @struct gpHci_LeRemoteConnectionParameterRequestEventParams_t */
typedef struct {
    gpHci_ConnectionHandle_t       connectionHandle;
...
} gpHci_LeRemoteConnectionParameterRequestEventParams_t;
...
/** @struct gpHci_LeLongTermKeyRequestEventParams_t */
typedef struct {
    gpHci_ConnectionHandle_t       connectionHandle;
    UInt8                          randomNumber[GP_HCI_RANDOM_DATA_LENGTH];
    UInt16                         encryptedDiversifier;
} gpHci_LeLongTermKeyRequestEventParams_t;
...
/** @struct gpHci_LeAdvertisingReportEventParams_t */
typedef struct {
    UInt8                          nrOfReports;
    gpHci_ReportPayload_t          reports[GP_HCI_MAX_NR_OF_ADV_REPORTS_IN_EVENT];
} gpHci_LeAdvertisingReportEventParams_t;

/** @struct gpHci_LeDirectAdvertisingReportEventParams_t */
typedef struct {
    UInt8                          nrOfReports;
    gpHci_ReportPayload_t          reports[GP_HCI_MAX_NR_OF_ADV_REPORTS_IN_EVENT];
} gpHci_LeDirectAdvertisingReportEventParams_t;

/** @struct gpHci_LeExtendedAdvertisingReportEventParams_t */
typedef struct {
    UInt8                          nrOfReports;
    gpHci_ExtReportPayload_t       reports[GP_HCI_MAX_NR_OF_ADV_REPORTS_IN_EVENT];
} gpHci_LeExtendedAdvertisingReportEventParams_t;

/** @struct gpHci_LeDataLengthChangeEventParams_t */
typedef struct {
    gpHci_ConnectionHandle_t       connectionHandle;
    UInt16                         MaxTxOctets;
    UInt16                         MaxTxTime;
    UInt16                         MaxRxOctets;
    UInt16                         MaxRxTime;
} gpHci_LeDataLengthChangeEventParams_t;
...
/** @struct gpHci_LePeriodicAdvertisingSyncEstablishedEventParams_t
...
} gpHci_LePeriodicAdvertisingSyncEstablishedEventParams_t;

/** @struct gpHci_LePeriodicAdvertisingReportEventParams_t
...
typedef struct {
    ...
    UInt8                          dataLength;
    UInt8*                         data;
} gpHci_LePeriodicAdvertisingReportEventParams_t;

/** @struct gpHci_LePeriodicAdvertisingSyncLostEventParams_t
 *  @brief 7.7.65.16 LE Periodic Advertising Sync Lost Event
*/
typedef struct {
    gpHci_SyncHandle_t             syncHandle;
} gpHci_LePeriodicAdvertisingSyncLostEventParams_t;

/** @struct gpHci_LePeriodicAdvertisingSyncTransferReceivedEventParams_t
...
typedef struct {
    ...
    UInt16                         periodicAdvertisingInterval;
    gpHci_ClockAccuracy_t          advertiserClockAccuracy;
} gpHci_LePeriodicAdvertisingSyncTransferReceivedEventParams_t;

/** @struct gpHci_LeCisEstablishedEventParams_t
...
} gpHci_LeCisEstablishedEventParams_t;

/** @struct gpHci_LeCisRequestEventParams_t
...
typedef struct {
    ...
    gpHci_CigId_t                  cigId;
    gpHci_CisId_t                  cisId;
} gpHci_LeCisRequestEventParams_t;

/** @struct gpHci_LeCreateBigCompleteEventParams_t */
typedef struct {
    gpHci_Result_t                 status;
    gpHci_BigHandle_t              bigHandle;
    UInt24                         bigSyncDelay;
    UInt24                         transportLatencyBig;
    gpHci_Phy_t                    phy;
    UInt8                          nse;
    UInt8                          bn;
    UInt8                          pto;
    ...
    UInt16                         isoInterval;
    UInt8                          numBis;
    gpHci_ConnectionHandle_t       connectionHandles[GP_HCI_NUMBIS_SPEC_MAX];
} gpHci_LeCreateBigCompleteEventParams_t;

/** @struct gpHci_LeTerminateBigCompleteEventParams_t */
typedef struct {
    gpHci_BigHandle_t              bigHandle;
    gpHci_Result_t                 reason;
} gpHci_LeTerminateBigCompleteEventParams_t;

/** @struct gpHci_LeRequestPeerScaCompleteEventParams_t */
typedef struct {
    gpHci_Result_t                 status;
    gpHci_ConnectionHandle_t       connectionHandle;
    gpHci_ClockAccuracy_t          peerClockAccuracy;
} gpHci_LeRequestPeerScaCompleteEventParams_t;

/** @struct gpHci_LeBigInfoAdvertisingReportEventParams_t */
typedef struct {
    gpHci_SyncHandle_t             syncHandle;
    UInt8                          numBis;
    UInt8                          nse;
    ...
    gpHci_Encryption_t             encryption;
} gpHci_LeBigInfoAdvertisingReportEventParams_t;

/** @struct gpHci_VsdFilterAcceptListModifiedEventParams_t */
typedef struct {
    BtDeviceAddress_t              address;
    Bool                           isAdded;
} gpHci_VsdFilterAcceptListModifiedEventParams_t;

/** @struct gpHci_VsdForwardEventProcessedMessagesParams_t */
typedef struct {
    UInt8                          connId;
    UInt16                         eventCounter;
    UInt32                         tsLastValidPacketReceived;
    UInt32                         tsLastPacketReceived;
} gpHci_VsdForwardEventProcessedMessagesParams_t;
