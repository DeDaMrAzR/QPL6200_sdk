...
typedef struct {
    ...
    gpHci_Encryption_t                       encryption;
    UInt8*                                   broadcastCode;
} gpHci_LeCreateBigTestCommand_t;

typedef struct {
    gpHci_BigHandle_t                        bigHandle;
    gpHci_Result_t                           reason;
} gpHci_LeTerminateBigCommand_t;
...
typedef struct {
    ...
    UInt8                                    numBis;
    UInt8*                                   pBis;
} gpHci_LeBigCreateSyncCommand_t;

typedef struct {
    gpHci_BigHandle_t                        bigHandle;
} gpHci_LeBigTerminateSyncCommand_t;
...
typedef struct {
    gpHci_ConnectionHandle_t                 connHandle;
    Bool                                     disabled;
} gpHci_VsdDisablePeripheralLatencyCommand_t;
...
typedef struct {
    gpHci_CoexParams_t                       per_conn;
} gpHci_VsdSetConnSlaCoexParamsCommand_t;

typedef struct {
    gpHci_CoexParams_t                       central_conn;
...
typedef struct {
    gpHci_VsdMetaSubEventCode_t              eventCode;
...
typedef struct {
    UInt32                                   intervalMs;
} gpHci_VsdEnablePeriodicRfCalibrationCommand_t;
...
typedef struct {
    ...
    UInt16                                   TxDataLength;
    UInt8*                                   TxData;
} gpHci_VsdSetDirectTestModeTxDataCommand_t;
...
typedef union {
    ...
    gpHci_LeCreateBigCommand_t                                             LeCreateBig;
    gpHci_LeCreateBigTestCommand_t                                         LeCreateBigTest;
    gpHci_LeTerminateBigCommand_t                                          LeTerminateBig;
    gpHci_LeBigCreateSyncCommand_t                                         LeBigCreateSync;
    gpHci_LeBigTerminateSyncCommand_t                                      LeBigTerminateSync;
    ...
    gpHci_VsdDisablePeripheralLatencyCommand_t                             VsdDisablePeripheralLatency;
    ...
    gpHci_VsdEnablePeriodicRfCalibrationCommand_t                          VsdEnablePeriodicRfCalibration;
    gpHci_VsdSetDirectTestModeTxDataCommand_t                              VsdSetDirectTestModeTxData;
