...
#ifdef GP_COMP_BLECHANNELMAPMANAGER
#include "gpBleChannelMapManager.h"
#endif //GP_COMP_BLECHANNELMAPMANAGER
...
#ifdef GP_COMP_BLECRYPTO
#include "gpBleCrypto.h"
#endif //GP_COMP_BLECRYPTO
...
#ifdef GP_COMP_BLEBIGMANAGER
#include "gpBleBigManager.h"
#endif //GP_COMP_BLEBIGMANAGER
...
#ifdef GP_COMP_BLECHANNELMAPMANAGER
    gpBleChannelMapManager_Reset(firstReset);
#endif //GP_COMP_BLECHANNELMAPMANAGER
...
#ifdef GP_COMP_BLEBIGMANAGER
    gpBleBigManager_Reset(firstReset);
#endif //GP_COMP_BLEBIGMANAGER
