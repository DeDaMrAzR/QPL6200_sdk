...
typedef struct {
    UInt8 clientID;
} gpPTC_GetInternalTemp_Input_struct_t;

typedef struct {
    gpPTC_GetInternalTemp_Input_struct_t data;
} gpPTC_GetInternalTemp_Input_marshall_struct_t;

typedef struct {
    Int16 temp;
} gpPTC_GetInternalTemp_Output_struct_t;

typedef struct {
    gpPTC_GetInternalTemp_Output_struct_t data;
} gpPTC_GetInternalTemp_Output_marshall_struct_t;


typedef struct {
    UInt8 tempIndex;
} gpPTC_GetCapacitorLoad_Input_struct_t;

typedef struct {
    gpPTC_GetCapacitorLoad_Input_struct_t data;
} gpPTC_GetCapacitorLoad_Input_marshall_struct_t;

typedef struct {
    Int16 coefficient;
} gpPTC_GetCapacitorLoad_Output_struct_t;

typedef struct {
    gpPTC_GetCapacitorLoad_Output_struct_t data;
} gpPTC_GetCapacitorLoad_Output_marshall_struct_t;
...
typedef union {
    ...
    gpPTC_GetInternalTemp_Input_marshall_struct_t gpPTC_GetInternalTemp;
    gpPTC_GetCapacitorLoad_Input_marshall_struct_t gpPTC_GetCapacitorLoad;
...
typedef union {
    ...
    gpPTC_GetInternalTemp_Output_marshall_struct_t gpPTC_GetInternalTemp;
    gpPTC_GetCapacitorLoad_Output_marshall_struct_t gpPTC_GetCapacitorLoad;
    UInt8 dummy; //ensure none empty union definition
...
gpMarshall_AckStatus_t gpPTC_GetInternalTemp_Input_buf2api(gpPTC_GetInternalTemp_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpPTC_GetInternalTemp_Output_api2buf(UInt8Buffer* pDest , gpPTC_GetInternalTemp_Output_marshall_struct_t* pSourceoutput , gpPTC_GetInternalTemp_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
gpMarshall_AckStatus_t gpPTC_GetCapacitorLoad_Input_buf2api(gpPTC_GetCapacitorLoad_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpPTC_GetCapacitorLoad_Output_api2buf(UInt8Buffer* pDest , gpPTC_GetCapacitorLoad_Output_marshall_struct_t* pSourceoutput , gpPTC_GetCapacitorLoad_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
void gpPTC_DiscoverIndication_Input_par2api(UInt8Buffer* pDest , gpPTC_DiscoveryInfo_t* pDiscoveryInfo , UInt16* pIndex);
void gpPTC_RXPacketIndication_Input_par2api(UInt8Buffer* pDest , UInt8 lqi , UInt8 antenna , Int8 rssi , UInt8 channel , UInt8 datalength , UInt8* payload , UInt8 statsDump , UInt16* pIndex);
...
void gpPTC_GetInternalTemp_Input_par2buf(UInt8Buffer* pDest , UInt8 clientID , UInt16* pIndex);
void gpPTC_GetInternalTemp_Output_buf2par(Int16* temp , UInt8 clientID , UInt8Buffer* pSource , UInt16* pIndex);
void gpPTC_GetCapacitorLoad_Input_par2buf(UInt8Buffer* pDest , UInt8 tempIndex , UInt16* pIndex);
void gpPTC_GetCapacitorLoad_Output_buf2par(Int16* coefficient , UInt8 tempIndex , UInt8Buffer* pSource , UInt16* pIndex);
