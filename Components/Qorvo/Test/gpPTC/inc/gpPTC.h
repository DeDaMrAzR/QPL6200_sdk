...
#define gpPTC_ResultTXDataNotSet                               0x0a
/** @brief Invalid Tx data length for rf4ce transmit packet */
#define gpPTC_ResultInvalidTXDataLength                        0x0b
...
//@{
/** @brief Channel of SrcId 0 that the device will transmit or listen on (for all PHYs). */
...
#define gpPTC_AttributeTXPower                                 0x0A
#define gpPTC_AttributePanID                                   0x0B
#define gpPTC_AttributeShortAddress                            0x0C
#define gpPTC_AttributeCWMode                                  0x0D
#define gpPTC_AttributePowerControlLoop                        0x0E
/** @brief Value representing the address that will be used with the ReadRegister mode. */
#define gpPTC_AttributeReadRegisterAddress                     0x0F
/** @brief Value representing the address that will be used with the WriteRegister mode. */
#define gpPTC_AttributeWriteRegisterAddress                    0x10
/** @brief Value that will be written to selected register with the WrigeRegister mode. */
#define gpPTC_AttributeWriteRegisterValue                      0x11
/** @brief Special case to set the byte array as the data payload for tx */
#define gpPTC_AttributeSetTxData                               0x12
/** @brief Sets the interval between packets in a packet train when transmitting multiple packets. */
#define gpPTC_AttributePacketIntervalInMS                      0x13
/** @brief Number of scans to be done by ED Scan */
#define gpPTC_AttributeScanCount                               0x14
/** @brief Number of packets that will be transmitted in a packet train. */
#define gpPTC_AttributePacketCount                             0x15
#define gpPTC_AttributePacketInPacket                          0x16
#define gpPTC_AttributePromiscuousMode                         0x17
#define gpPTC_AttributePacketLength                            0x18
/** @brief Write register values only for the specified bitmask */
#define gpPTC_AttributeWriteRegisterBitsMask                   0x19
#define gpPTC_AttributeWriteRegisterBitsValue                  0x1A
#define gpPTC_AttributePhyMode                                 0x1B
#define gpPTC_BLE_DTM_PacketType                               0x1C
#define gpPTC_AttributeScanIntervalInMS                        0x1D
#define gpPTC_BLE_DataRate                                     0x1E
#define gpPTC_AttributeMapClockType                            0x1F
#define gpPTC_AttributeMapClockIOPin                           0x20
#define gpPTC_AttributeRxLnaAttDuringTimeout                   0x21
#define gpPTC_AttributeRxMultiStandard                         0x22
#define gpPTC_AttributeRxHighSensitivity                       0x23
#define gpPTC_AttributeRxMultiChannel                          0x24
#define gpPTC_AttributePDMClkSrc                               0x25
#define gpPTC_AttributePDMClkFreq                              0x26
#define gpPTC_AttributePDMClkOutPin                            0x27
/** @brief Channel that the device will transmit or listen on (for all PHYs). Alias for deprecated "CH" */
#define gpPTC_AttributeChannelSrcId0                           0x28
/** @brief 802.15.4 rx channel of SrcId 1 that the device will listen on when ConcurrentConect multi-channel is enabled */
#define gpPTC_AttributeChannelSrcId1                           0x29
/** @brief 802.15.4 rx channel of SrcId 2 that the device will listen on when ConcurrentConect multi-channel is enabled */
#define gpPTC_AttributeChannelSrcId2                           0x2A
...
#define gpPTC_AttributeXtalTrimCapZone1MaxTemp                 0x2B
#define gpPTC_AttributeXtalTrimCapZone2MaxTemp                 0x2C
#define gpPTC_AttributeXtalTrimCapZone3MaxTemp                 0x2D
#define gpPTC_AttributeXtalTrimCapZone4MaxTemp                 0x2E
#define gpPTC_AttributeXtalTrimCapZone5MaxTemp                 0x2F
#define gpPTC_AttributeXtalTrimCapZone6MaxTemp                 0x30
...
#define gpPTC_AttributeXtalTrimCapZone1Setting                 0x31
#define gpPTC_AttributeXtalTrimCapZone2Setting                 0x32
#define gpPTC_AttributeXtalTrimCapZone3Setting                 0x33
#define gpPTC_AttributeXtalTrimCapZone4Setting                 0x34
#define gpPTC_AttributeXtalTrimCapZone5Setting                 0x35
#define gpPTC_AttributeXtalTrimCapZone6Setting                 0x36
#define gpPTC_AttributeXtalTrimCapZone7Setting                 0x37
#define gpPTC_AttributeWsetChannel                             0x38
#define gpPTC_AttributeWgetChannel                             0x39
#define gpPTC_AttributeWsetPower                               0x3A
#define gpPTC_AttributeTxmcCurrentChSeq                        0x3B
#define gpPTC_AttributeTxmcChannel                             0x3C
#define gpPTC_AttributeTxmcPacketCount                         0x3D
#define gpPTC_AttributeTxmcData                                0x3E
#define gpPTC_AttributeTxmcDataLength                          0x3F
#define gpPTC_AttributeTxmcPacketInterval                      0x40
#define gpPTC_AttributePCHStatChannel                          0x41
#define gpPTC_AttributeDumpRxp                                 0x42
#define gpPTC_AttributeDumpP                                   0x43
#define gpPTC_AttributeDCDC                                    0x44
#define gpPTC_BLE_RxDataRate                                   0x45
#define gpPTC_BLE_TxDataRate                                   0x46
/** @brief This defines the number of elements defined in this enum. This can be used as the size of the buffer array.
 * The value needs to be increased when a new attribute is defined.Not to be used as attribute ! */
#define PTC_ATTRIBUTES_MAX_NUMBER 0x45
...
#define gpPTC_ModePrintPacketCount                             0x0A
#define gpPTC_ModeResetCounters                                0x0B
#define gpPTC_ModePrintReceivedPackets                         0x0C
#define gpPTC_ModeTransmitRandomPackets                        0x0D
#define gpPTC_ModeWriteRegisterBits                            0x0E
#define gpPTC_ModeSetClockToGPIO                               0x0F
#define gpPTC_ModeXtalSelfTest                                 0x10
#define gpPTC_ModeSetPdmClock                                  0x11
#define gpPTC_ModeSetXtalTrimCap                               0x12
#define gpPTC_ModeSetTxPowerChannel                            0x13
#define gpPTC_ModeGetTxPowerChannel                            0x14
#define gpPTC_ModeTransmitMultipleChannels                     0x15
#define gpPTC_ModePrintTxmcConfiguraiton                       0x16
#define gpPTC_ModePrintPacketCountForChannel                   0x17
#define gpPTC_ModeResetCountersForChannel                      0x18
#define gpPTC_ModePrintAntennaStatistics                       0x19
#define gpPTC_ModeResetAntennaStatistics                       0x1A
#define gpPTC_ModeGetChipTemp                                  0x1B
#define gpPTC_ModeGetCapacitorLoad                             0x1C
...
/** @enum gpPTC_StatsDump_t */
//@{
#define gpPTC_StatsDump_Off 0
#define gpPTC_StatsDump_Csv 1
typedef UInt8 gpPTC_StatsDump_t;
//@}
 ...
 *   @param csvDump
 */
void gpPTC_RXPacketIndication(UInt8 lqi, UInt8 antenna, Int8 rssi, UInt8 channel, UInt8 datalength, UInt8* payload,
...
/** @brief Get a chip internal temperature in Q8_8 format
*
*   @param clientID
