...
{
    Int16_api2buf_1(pDest, &(pSourceoutput->data.temp), pIndex);
}
...
{
    UInt8_buf2api_1(&(pDest->data.tempIndex), pSource, pIndex);
    return gpMarshall_AckStatusSuccess;
}
...
{
    Int16_api2buf_1(pDest, &(pSourceoutput->data.coefficient), pIndex);
}
...
{
    UInt8_api2buf_1(pDest , &(lqi) , pIndex);
    UInt8_api2buf_1(pDest , &(antenna) , pIndex);
    Int8_api2buf_1(pDest , &(rssi) , pIndex);
    ...
    UInt8_api2buf_1(pDest , &(statsDump) , pIndex);
}
