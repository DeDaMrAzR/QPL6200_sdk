...
#define RT_COMPRESSED_PTR_INVALID       0x0000
...
typedef uintptr_t format_ptr_t;

typedef UInt8 ttb_event_handle_t;

// cfr the values from rt_error_type in sw_reg_enum.h
typedef UInt8 rt_error_type;
