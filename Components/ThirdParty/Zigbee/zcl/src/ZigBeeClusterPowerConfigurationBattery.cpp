...
const unsigned short CQorvoClusterPowerConfigurationBattery::nClusterRevision =
	CQorvoClusterPowerConfigurationBattery::revision;

CQorvoClusterPowerConfigurationBattery::CQorvoClusterPowerConfigurationBattery
...
/////////////////////////////////////////////////////////////////////////////
// CQorvoClusterPowerConfigurationBattery attribute map

__COMPACT7B_IMPLEMENT_ATTRIBUTE_MAP(CQorvoClusterPowerConfigurationBattery, CZigBeeCluster)

__COMPACT7B_BEGIN_ATTRIBUTE_MAP(CQorvoClusterPowerConfigurationBattery)
    __COMPACT7B_CLUSTERREVISION(CQorvoClusterPowerConfigurationBattery)
    __COMPACT7B_POWERCONFIGURATIONBATTERY_CLUSTER_ATTRIBUTES()
