/**
 * @brief eSecure Library: SRP functions
 * @copyright Copyright (c) 2017-2019 Silex Insight. All Rights reserved
 * @file
 */

#ifndef ESEC_SRP_HEADER
#define ESEC_SRP_HEADER
...
/** Create a SRP verifier from the user credentials.
 *
...
/** Create a user session state to establish a connection with a server via SRP
 *
...
/** Create a session state to establish a connection with a user via SRP
 *
...
/** Generate a shared key at the user side
 *
...
/** Generate a shared key at the server side
 *
