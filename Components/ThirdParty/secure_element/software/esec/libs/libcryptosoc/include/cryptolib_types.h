...
/** @brief value of ::block_s.flags to suggest point bundling */
#define BLOCK_S_BUNDLE 	       	      0x20000000
...
/** @brief mask for ::block_s.flags to only get the key id for isolated key */
#define BLOCK_S_FLAG_MASK_KEY_ID       0x00000003
