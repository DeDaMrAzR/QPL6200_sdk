...
{
    gpHci_CommandParameters_t cmd;
    cmd.VsdDisablePeripheralLatency.connHandle = handle;
    cmd.VsdDisablePeripheralLatency.disabled = disabled;

    gpBle_ExecuteCommand(gpBle_EventServer_Host, gpHci_OpCodeVsdDisablePeripheralLatency, gpBle_VsdDisablePeripheralLatency, &cmd);
