...
.SECONDEXPANSION:
$(WORKDIR)/%.o: $(ROOTDIR)/%.cc | $$(dir $$@) $(dir $(PREREQ_HEADER_GENERATION_TARGETS)) $(PREREQ_HEADER_GENERATION_TARGETS)
	$(call compile,$(CXX), $(CXXFLAGS))

.SECONDEXPANSION:
$(WORKDIR)/%.o: $(GPHUB_ROOT)/%.cc | $$(dir $$@) $(dir $(PREREQ_HEADER_GENERATION_TARGETS)) $(PREREQ_HEADER_GENERATION_TARGETS)
	$(call compile,$(CXX), $(CXXFLAGS))
...
.SECONDEXPANSION:
$(WORKDIR)/%.lst: $(ROOTDIR)/%.cc | $$(dir $$@) $(dir $(PREREQ_HEADER_GENERATION_TARGETS)) $(PREREQ_HEADER_GENERATION_TARGETS)
	$(call list,$(CXX), $(CXXFLAGS))

.SECONDEXPANSION:
$(WORKDIR)/%.lst: $(GPHUB_ROOT)/%.cc | $$(dir $$@) $(dir $(PREREQ_HEADER_GENERATION_TARGETS)) $(PREREQ_HEADER_GENERATION_TARGETS)
	$(call list,$(CXX), $(CXXFLAGS))
